package kr.co.gitt.kworks.projects.sc.web.clipreport;
...
///   -# 
/////////////////////////////////////////////
@Controller("scClipReportController")
...
public class ClipReportController {
	...
	public String ugrwtr(@RequestParam("ftrCde") String ftrCde, @RequestParam("objectid") String objectid, HttpServletRequest request, Model model) throws UnsupportedEncodingException{
	...
	public String ctrlpnt(@RequestParam("ftrCde") String ftrCde, @RequestParam("ftrIdn") String ftrIdn, HttpServletRequest request, Model model) throws UnsupportedEncodingException{
		...
		StringBuffer path = new StringBuffer();
		path.append("%root%/crf/sc/cntrPnt/ETL_RGCP_PS.crf");
