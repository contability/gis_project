...
<form:form commandName="bmlWellPs">
	<div class="search ma_t_5">
		...
		<form:select class="selectBox w_160" name="permNtFo" path="permNtFo">
			<form:option value="" label="전체"/>
			<form:options items="${permNtFo}" itemValue="codeId" itemLabel="codeNm" />
		</form:select>
	</div>
	<div class="search ma_t_5">
		<span class="display_in w_80 ma_l_20">법정동</span>
		<form:select class="selectBox w_160" name="dvopLocC" path="dvopLocC">
			<form:option value="" label="전체"/>
			<form:options items="${dvopLocC}" itemValue="codeId" itemLabel="codeNm" />
		</form:select>
