...
import kr.co.gitt.kworks.projects.gn.mappers.WttSplyMaMapper;
...
public class WspCntrwkRegstrServiceImpl implements WspCntrwkRegstrService {
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.gn.service.cntrwkRegstr.WspCntrwkRegstrService#listWspCntrwkRegstr(kr.co.gitt.kworks.projects.gn.model.WttSplyMa)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.gn.service.cntrwkRegstr.WspCntrwkRegstrService#selectOneWspCntrwkRegstr(java.lang.Long)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.gn.service.cntrwkRegstr.WspCntrwkRegstrService#modifyWspCntrwkRegstr(kr.co.gitt.kworks.projects.gn.model.WttSplyMa)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.gn.service.cntrwkRegstr.WspCntrwkRegstrService#addWspCntrwkRegstr(kr.co.gitt.kworks.projects.gn.model.WttSplyMa)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.gn.service.cntrwkRegstr.WspCntrwkRegstrService#searchSpatial(java.lang.Long)
	/////////////////////////////////////////////
	@Override
