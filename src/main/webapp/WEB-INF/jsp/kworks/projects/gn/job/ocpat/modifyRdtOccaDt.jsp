...
<form id="modifyRdtOccaDtModifyform" name="modifyRdtOccaDtModifyform" method="post"	enctype="multipart/form-data">
	<div id="modifyRdtOccaDtRegstr" class="window_container">
