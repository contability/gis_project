...
<!-- 통합 검색 팝업 -->
<div class="div_window_unity_search">

	<div class="ma_b_20 f_l">
		<div class="f_l w_150 pa_t_10 pa_r_5 ma_b_10 ma_b_5">
			<div class="bg_gray1 t_a_c">
				<span class="h_28 f_s_12 color_black bold pa_l_5">조건검색대상</span>
			</div>
			<div class="listBox bd_gray3 ma_t_10 over_ys h_180">
				<ul class="ul_datas ul_content">
				</ul>
			</div>
		</div>
		<div class="f_l w_150 pa_t_10 pa_r_5 ma_b_10 ma_b_5">
		...
		<div class="f_l w_180 pa_t_10 pa_r_5">
			...
			<div class="div_condition_field div_number_field f_l layerSet pa_t_10">
				<ul>
					<li class="h_28 pa_l_10">
						<input id="chk_unity_search_number_range" name="chk_unity_search_number" value="range" class="ma_r_5" type="radio" checked="checked" />
						<span class="f_s_12 color_7"><label for="chk_unity_search_number_range">범위</label></span>
					</li>
					...
					<li class="h_28 pa_l_10 pa_t_10">
						<input id="chk_unity_search_number_equals" name="chk_unity_search_number" value="equals" class="ma_r_5" type="radio" />
						<span class="f_s_12 color_7"><label for="chk_unity_search_number_equals">특정값</label></span>
					</li>
			...
			<div class="div_condition_field div_date_field f_l layerSet pa_t_10">
				<ul>
					<li class="h_28 pa_l_10">
						<input id="chk_unity_search_date_range" name="chk_unity_search_date" value="range" class="ma_r_5" type="radio" checked="checked" />
						<span class="f_s_12 color_7"><label for="chk_unity_search_date_range">범위</label></span>
					</li>
					<li class="h_24 pa_l_10">
					...
					<li class="h_28 pa_l_10 pa_t_10">
						<input id="chk_unity_search_date_equals" name="chk_unity_search_date" value="equals" class="ma_r_5" type="radio" />
						<span class="f_s_12 color_7"><label for="chk_unity_search_date_equals">특정일</label></span>
					</li>
					<li class="h_20 pa_l_10">
						<span class="f_s_12 color_6">
