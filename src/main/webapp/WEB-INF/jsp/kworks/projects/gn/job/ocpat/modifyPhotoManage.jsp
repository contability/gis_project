...
<div class="layerCont">
	<form method="post" action="<c:url value='/ocpat/updateFile.do' />" enctype="multipart/form-data" >
		<table class="cmmTable v2" summary="파일정보 수정 테이블">
			<caption>사진정보 수정 테이블</caption>
			<colgroup>
				<col width="23%" />
				<col width="*" />
			</colgroup>
			<tbody id="tbl_file_manage_modify">
				<input type="hidden" id="txt_modify_file_manage_no" name="ocpatFileNo" class="w100" value="" />
				<input type="hidden" id="txt_modify_file_manage_ftr_idn" name="ftrIdn" class="w100" value="" />
				<input type="hidden" id="txt_modify_file_manage_file_no" name="fileNo" class="w100" value="" />
				<tr>
					<th scope="row">대장명</th>
					<td>
						<input id="txt_modify_file_manage_ftr_cde_nam" class="w100" value="" disabled="disabled" />
						<input type="hidden" id="txt_modify_file_manage_ftr_cde" name="ftrCde" class="w100" value="" />
					</td>
				</tr>	
				<tr>
					<th scope="row">부속자료</th>
					<td>
						<select id="txt_modify_file_manage_sj" name="fileSj" class="w100 easyui-combobox">
				...
				<tr>
					<th scope="row">내용</th>
					<td>
						<textarea id="txt_modify_file_manage_cn" name="fileCn" class="textArea w100 h_80"></textarea>
					</td>
				</tr>
				<tr>
					<th scope="row">파일</th>
		...
		<div class="div_tool_photo_manage">
			<a class="a_save_modify_file_manage btn_register" href="#" ></a>
			<a class="a_close_modify_file_manage btn_close" href="#" ></a>
		</div>
	</form>
</div>
