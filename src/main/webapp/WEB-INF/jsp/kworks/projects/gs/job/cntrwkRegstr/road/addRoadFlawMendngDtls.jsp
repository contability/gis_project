...
<form id="addRoadFlawMendngDtlsAdd" name="addRoadFlawMendngDtlsAdd" method="post" enctype="multipart/form-data">
	<div class="window_container">
		...
		<div class="window_footer">
			<div class="button_flat">
				<button class="btn_save_roadFlawMendngDtlsAdd button_flat_normal btn_blue">등록</button>
			</div>
		</div>
	</div>
</form>
