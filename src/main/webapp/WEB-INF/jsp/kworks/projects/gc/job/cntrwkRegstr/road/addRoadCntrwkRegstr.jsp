...
<form id="addRoadCntrwkRegstrAddform" name="addRoadCntrwkRegstrAddform" method="post" enctype="multipart/form-data">
	<div id="roadCntrwkRegstrAdd" class="window_container">
			...
			<table class="table_text">
				<tbody>
					<tr>
						...
						<th>e호조번호</th>
						<td>
							<input type="text" name="cttNum" class="input_text_w w_165" value="" />
							<button class="btn_eHojoSearch_roadCntrwkRegstrAdd button_flat_w_h_custom btn_blue w_43 h_21">조회</button>
						</td>
					</tr>
				</tbody>
			</table>
					...
					<table class="table_text">
						<tbody>
							<tr>
								...
								<th>착공일자</th>
								<td>
									<input type="text" name="begYmd" class="begYmd input_text easyui-datebox" value="" />
								</td>
							</tr>
							<tr>
								<th>준공검사자</th>
								...
								<th>준공예정일</th>
								<td>
									<input type="text" name="fnsYmd" class="fnsYmd input_text easyui-datebox" value="" />
								</td>
							</tr>
							<tr>
								<th>준공검사일</th>
								<td>
									<input type="text" name="fchYmd" class="fchYmd input_text easyui-datebox" value="" />
								</td>
								<th>실준공일</th>
								<td>
									<input type="text" name="rfnYmd" class="rfnYmd input_text easyui-datebox" value="" />
								</td>
							</tr>
							<tr>
								<th>관급물량</th>
				...
				<table class="table_text">
					<tbody>
						<tr>
							<th>입찰일자</th>
							<td>
								<input type="text" name="bidYmd" class="bidYmd input_text easyui-datebox" value="" />
							</td>
							<th>계약일자</th>
							<td>
								<input type="text" name="cttYmd" class="cttYmd input_text easyui-datebox" value="" />
							</td>
						</tr>
						<tr>
							<th>계약방법</th>
		...
		<div class="window_footer">
			<div class="button_flat">
				<button class="btn_save_roadCntrwkRegstrAdd button_flat_normal btn_blue">저장</button>
			</div>
		</div>
	</div>
</form>