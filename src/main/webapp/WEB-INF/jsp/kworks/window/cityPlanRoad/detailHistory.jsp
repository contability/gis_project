...
<form id="detailCityPlanRoadHistoryForm" name="detailCityPlanRoadHistoryForm" method="post" enctype="multipart/form-data">
	<div id="detailCityPlanRoadHistory" class="window_container">
				...
				<tbody>
					<c:if test="${editAt eq 'Y' or editAt eq 'y'}">
						...
						<tr>
							<th>고시근거</th>
							<td colspan="3">
								<input type="text" class="easyui-textbox" name="uprNty" style="width:99%" value="${row.uprNty}"/>						
							</td>
							<th>고시근거일</th>
							<td>
								<input type="text" class="w_110 easyui-datebox"	name="uprYmd" value="${row.uprYmd}" />						
							</td>
						</tr>
						<tr>
							<th>고시구분</th>
							<td colspan="5">
								<input type="text" class="easyui-textbox" name="uprCla" style="width:99%" value="${row.uprCla}"/>						
							</td>
						</tr>
						<tr>
							<th>비고</th>
					...
					<c:if test="${editAt eq 'N' or editAt eq 'n'}">
						...
						<tr>
							<th>고시근거</th>
							<td colspan="3" id="uptNty">${row.uprNty}</td>						
							<th>고시근거일</th>
							<td id="uprYmd">${row.uprYmd}</td>					
						</tr>
						<tr>
							<th>고시구분</th>
							<td colspan="5" id="uprCla">${row.uprCla}</td>
						</tr>
						<tr>
							<th>비고</th>
