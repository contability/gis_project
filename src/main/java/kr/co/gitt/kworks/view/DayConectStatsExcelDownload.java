...
@Component("dayConectStatsExcelDownload")
public class DayConectStatsExcelDownload extends AbstractExcelView {
	...
	protected void buildExcelDocument(Map<String, Object> model, HSSFWorkbook wb, HttpServletRequest req, HttpServletResponse res) throws Exception {
		...
		setText(getCell(sheet, 0, 1), "일별 접속자 수");
		setText(getCell(sheet, 0, 2), "일별 누적 접속자 수");
