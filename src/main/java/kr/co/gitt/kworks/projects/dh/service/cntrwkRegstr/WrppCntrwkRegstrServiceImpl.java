...
import kr.co.gitt.kworks.projects.dh.mappers.WttChngDtMapper;
import kr.co.gitt.kworks.projects.dh.mappers.WttConsMaMapper;
import kr.co.gitt.kworks.projects.dh.mappers.WttCostDtMapper;
import kr.co.gitt.kworks.projects.dh.mappers.WttFlawDtMapper;
import kr.co.gitt.kworks.projects.dh.mappers.WttSubcDtMapper;
...
public class WrppCntrwkRegstrServiceImpl implements WrppCntrwkRegstrService {
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.dh.service.cntrwkRegstr.CntrwkRegstrService#listWrpp(kr.co.gitt.kworks.projects.dh.model.WttConsMa)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.dh.service.cntrwkRegstr.CntrwkRegstrService#selectOne(java.lang.String)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.dh.service.cntrwkRegstr.CntrwkRegstrService#modifyWrppCntrwkRegstr(kr.co.gitt.kworks.projects.dh.model.WttConsMa)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.dh.service.cntrwkRegstr.CntrwkRegstrService#addWrppCntrwkRegstr(kr.co.gitt.kworks.projects.dh.model.WttConsMa)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.dh.service.cntrwkRegstr.CntrwkRegstrService#listWrppFlawMendngDtls(kr.co.gitt.kworks.projects.dh.model.WttFlawDt)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.dh.service.cntrwkRegstr.CntrwkRegstrService#selectOneWrppFlawMendngDtls(java.lang.Long, java.lang.Long)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.dh.service.cntrwkRegstr.CntrwkRegstrService#modifyWrppFlawMendngDtls(kr.co.gitt.kworks.projects.dh.model.WttFlawDt)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.dh.service.cntrwkRegstr.CntrwkRegstrService#addWrppFlawMendngDtls(kr.co.gitt.kworks.projects.dh.model.WttFlawDt)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.dh.service.cntrwkRegstr.CntrwkRegstrService#removeWrppFlawMendngDtls(java.lang.Long)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.dh.service.cntrwkRegstr.CntrwkRegstrService#listWrppCntrwkCtPymntDtls(kr.co.gitt.kworks.projects.dh.model.WttCostDt)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.dh.service.cntrwkRegstr.CntrwkRegstrService#selectOneWrppCntrwkCtPymntDtls(java.lang.Long, java.lang.Long)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.dh.service.cntrwkRegstr.CntrwkRegstrService#modifyWrppCntrwkCtPymntDtls(kr.co.gitt.kworks.projects.dh.model.WttCostDt)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.dh.service.cntrwkRegstr.CntrwkRegstrService#addWrppCntrwkCtPymntDtls(kr.co.gitt.kworks.projects.dh.model.WttCostDt)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.dh.service.cntrwkRegstr.CntrwkRegstrService#removeWrppCntrwkCtPymntDtls(java.lang.Long)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.dh.service.cntrwkRegstr.CntrwkRegstrService#listWrppDsgnChangeDtls(kr.co.gitt.kworks.projects.dh.model.WttChngDt)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.dh.service.cntrwkRegstr.CntrwkRegstrService#selectOneWrppDsgnChangeDtls(java.lang.Long, java.lang.Long)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.dh.service.cntrwkRegstr.CntrwkRegstrService#modifyWrppDsgnChangeDtls(kr.co.gitt.kworks.projects.dh.model.WttChngDt)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.dh.service.cntrwkRegstr.CntrwkRegstrService#addWrppDsgnChangeDtls(kr.co.gitt.kworks.projects.dh.model.WttChngDt)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.dh.service.cntrwkRegstr.CntrwkRegstrService#removeWrppDsgnChangeDtls(java.lang.Long)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.dh.service.cntrwkRegstr.CntrwkRegstrService#listWrppSubcntrDtls(kr.co.gitt.kworks.projects.dh.model.WttSubcDt)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.dh.service.cntrwkRegstr.CntrwkRegstrService#selectOneWrppSubcntrDtls(java.lang.Long, java.lang.Long)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.dh.service.cntrwkRegstr.CntrwkRegstrService#modifyWrppSubcntrDtls(kr.co.gitt.kworks.projects.dh.model.WttSubcDt)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.dh.service.cntrwkRegstr.CntrwkRegstrService#addWrppSubcntrDtls(kr.co.gitt.kworks.projects.dh.model.WttSubcDt)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.dh.service.cntrwkRegstr.CntrwkRegstrService#removeWrppSubcntrDtls(java.lang.Long)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.dh.service.cntrwkRegstr.WrppCntrwkRegstrService#addWrppCntrwkRegstrPhoto(kr.co.gitt.kworks.model.KwsImage, org.springframework.web.multipart.MultipartRequest)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.dh.service.cntrwkRegstr.WrppCntrwkRegstrService#modifyWrppCntrwkRegstrPhoto(kr.co.gitt.kworks.model.KwsImage, org.springframework.web.multipart.MultipartRequest)
	/////////////////////////////////////////////
	@Override
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.dh.service.cntrwkRegstr.WrppCntrwkRegstrService#searchSpatial(java.lang.Long)
	/////////////////////////////////////////////
	@Override
