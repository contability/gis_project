...
import kr.co.gitt.kworks.projects.sc.mappers.RdtChngDtMapper;
import kr.co.gitt.kworks.projects.sc.mappers.RdtConsMaMapper;
import kr.co.gitt.kworks.projects.sc.mappers.RdtCostDtMapper;
import kr.co.gitt.kworks.projects.sc.mappers.RdtFlawDtMapper;
import kr.co.gitt.kworks.projects.sc.mappers.RdtSubcDtMapper;
import kr.co.gitt.kworks.projects.sc.model.RdtChngDt;
import kr.co.gitt.kworks.projects.sc.model.RdtConsMa;
import kr.co.gitt.kworks.projects.sc.model.RdtCostDt;
import kr.co.gitt.kworks.projects.sc.model.RdtFlawDt;
import kr.co.gitt.kworks.projects.sc.model.RdtSubcDt;
...
public class RoadCntrwkRegstrServiceImpl implements RoadCntrwkRegstrService {
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.sc.service.cntrwkRegstr.CntrwkRegstrService#listRoad(kr.co.gitt.kworks.projects.sc.model.RdtConsMa)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.sc.service.cntrwkRegstr.CntrwkRegstrService#modifyRoadCntrwkRegstr(kr.co.gitt.kworks.projects.sc.model.RdtConsMa)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.sc.service.cntrwkRegstr.CntrwkRegstrService#addRoadCntrwkRegstr(kr.co.gitt.kworks.projects.sc.model.RdtConsMa)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.sc.service.cntrwkRegstr.CntrwkRegstrService#listRoadFlawMendngDtls(kr.co.gitt.kworks.projects.sc.model.RdtFlawDt)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.sc.service.cntrwkRegstr.CntrwkRegstrService#selectOneRoadFlawMendngDtls(java.lang.Long, java.lang.Long)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.sc.service.cntrwkRegstr.CntrwkRegstrService#modifyRoadFlawMendngDtls(kr.co.gitt.kworks.projects.sc.model.RdtFlawDt)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.sc.service.cntrwkRegstr.CntrwkRegstrService#addRoadFlawMendngDtls(kr.co.gitt.kworks.projects.sc.model.RdtFlawDt)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.sc.service.cntrwkRegstr.CntrwkRegstrService#removeRoadFlawMendngDtls(java.lang.Long)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.sc.service.cntrwkRegstr.CntrwkRegstrService#listRoadCntrwkCtPymntDtls(kr.co.gitt.kworks.projects.sc.model.RdtCostDt)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.sc.service.cntrwkRegstr.CntrwkRegstrService#selectOneRoadCntrwkCtPymntDtls(java.lang.Long, java.lang.Long)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.sc.service.cntrwkRegstr.CntrwkRegstrService#modifyRoadCntrwkCtPymntDtls(kr.co.gitt.kworks.projects.sc.model.RdtCostDt)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.sc.service.cntrwkRegstr.CntrwkRegstrService#addRoadCntrwkCtPymntDtls(kr.co.gitt.kworks.projects.sc.model.RdtCostDt)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.sc.service.cntrwkRegstr.CntrwkRegstrService#removeRoadCntrwkCtPymntDtls(java.lang.Long)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.sc.service.cntrwkRegstr.CntrwkRegstrService#listRoadDsgnChangeDtls(kr.co.gitt.kworks.projects.sc.model.RdtChngDt)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.sc.service.cntrwkRegstr.CntrwkRegstrService#selectOneRoadDsgnChangeDtls(java.lang.Long, java.lang.Long)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.sc.service.cntrwkRegstr.CntrwkRegstrService#modifyRoadDsgnChangeDtls(kr.co.gitt.kworks.projects.sc.model.RdtChngDt)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.sc.service.cntrwkRegstr.CntrwkRegstrService#addRoadDsgnChangeDtls(kr.co.gitt.kworks.projects.sc.model.RdtChngDt)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.sc.service.cntrwkRegstr.CntrwkRegstrService#removeRoadDsgnChangeDtls(java.lang.Long)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.sc.service.cntrwkRegstr.CntrwkRegstrService#listRoadSubcntrDtls(kr.co.gitt.kworks.projects.sc.model.RdtSubcDt)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.sc.service.cntrwkRegstr.CntrwkRegstrService#selectOneRoadSubcntrDtls(java.lang.Long, java.lang.Long)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.sc.service.cntrwkRegstr.CntrwkRegstrService#modifyRoadSubcntrDtls(kr.co.gitt.kworks.projects.sc.model.RdtSubcDt)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.sc.service.cntrwkRegstr.CntrwkRegstrService#addRoadSubcntrDtls(kr.co.gitt.kworks.projects.sc.model.RdtSubcDt)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.sc.service.cntrwkRegstr.CntrwkRegstrService#removeRoadSubcntrDtls(java.lang.Long)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.sc.service.cntrwkRegstr.RoadCntrwkRegstrService#addRoadCntrwkRegstrPhoto(kr.co.gitt.kworks.model.KwsImage, org.springframework.web.multipart.MultipartRequest)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.sc.service.cntrwkRegstr.RoadCntrwkRegstrService#modifyRoadCntrwkRegstrPhoto(kr.co.gitt.kworks.model.KwsImage, org.springframework.web.multipart.MultipartRequest)
	/////////////////////////////////////////////
	@Override
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.sc.service.cntrwkRegstr.RoadCntrwkRegstrService#searchSpatial(java.lang.Long)
	/////////////////////////////////////////////
	@Override
