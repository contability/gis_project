...
import kr.co.gitt.kworks.projects.dh.service.civilAppeal.WrppCivilAppealService;
...
public class WrppCivilAppealManageController {
	...
	public String searchWrppCivilAppealPage(WttWserMa wttWserMa, Model model) {
		...
		return "/projects/dh/job/civilAppeal/wrpp/searchWrppCivilAppeal";
	}
