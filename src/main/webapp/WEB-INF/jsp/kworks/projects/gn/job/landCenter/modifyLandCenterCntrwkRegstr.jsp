			...
			<table class="table_text">
				<tbody>
					...
					<tr>
						<th>공사명</th>
						<td colspan="3">
							<input type="text" name="cntNam" class="easyui-textbox" value="${result.cntNam}" style="width: 100%;"/>
						</td>
					</tr>
				</tbody>
			</table>
				...
				<table class="table_text">			
					<tbody>
						<tr>
							<th>공사부서</th>
							<td colspan="3">
							<select name="cntDept" class="modify_cnt_dept easyui-combobox" style="width: 100%;">
						...
						<tr>
							<th>도급자</th>
							<td>
								<input type="text" name="gcnNam" class="easyui-textbox" value="${result.gcnNam}"/>
							</td>
							<th>대표자 성명</th>
							<td>
						...
						<tr>
							...
							<th>계약일</th>
							<td>
								<input type="text" name="cttYmd" class="easyui-datebox" value="${result.cttYmd}"/>
							</td>
						</tr>
						<tr>
							<th>착공일</th>
							...
							<th>준공기한</th>
							<td>
								<input type="text" name="fnsYms" class="easyui-datebox" value="${result.fnsYms}"/>
							</td>
						</tr>
						<tr>
							<th>준공일</th>
