goog.provide('kworks.interaction.Downwid');
goog.provide('kworks.interaction.DownwidEventType');
goog.provide('kworks.interaction.DownwidEvent');
 ...
 * @enum {string}
 */
kworks.interaction.DownwidEventType = {
	/**
	 * Triggered upon feature modification start
	 * @event kworks.interaction.DownwidEvent #downwidstart
	 * @api
	 */
	DOWNWIDSTART: 'downwidstart',
		
	/**
	 * Triggered upon feature modification end
	 * @event kworks.interaction.DownwidEvent #downwidend
	 * @api
	 */
	DOWNWIDEND: 'downwidend'
};


/**
 * @classdesc
 * Events emitted by {@link kworks.interaction.Downwid} instances are instances of
 * this type.
 *
 * @constructor
 * @extends {goog.events.Event}
 * @implements {kworks.interaction.DownwidEvent}
 * @param {kworks.interaction.DownwidEventType} type Type.
 * @param {ol.Collection.<ol.Feature>} features The features modified.
 * @param {ol.MapBrowserPointerEvent} mapBrowserPointerEvent Associated {@link ol.MapBrowserPointerEvent}.
 */
kworks.interaction.DownwidEvent = function(type, features, mapBrowserPointerEvent) {
...
goog.inherits(kworks.interaction.DownwidEvent, goog.events.Event);
 ...
 * @api stable
 */
kworks.interaction.Downwid = function(options) {

	goog.base(this, {
		handleDownEvent: kworks.interaction.Downwid.handleDownEvent_,
	    handleDragEvent: kworks.interaction.Downwid.handleDragEvent_,
	    handleEvent: kworks.interaction.Downwid.handleEvent,
	    handleUpEvent: kworks.interaction.Downwid.handleUpEvent_
	});	
	...
	this.overlay_ = new ol.layer.Vector({
	    ...
	    wrapX : !!options.wrapX}),
	    style : options.style ? options.style : kworks.interaction.Downwid.getDefaultStyleFunction(),
...
goog.inherits(kworks.interaction.Downwid, ol.interaction.Pointer);


kworks.interaction.Downwid.prototype.setFeatures = function(features) {
...
kworks.interaction.Downwid.prototype.clearFeatures = function() {
	if(this.features_) {
		goog.events.listen(this.features_, ol.CollectionEventType.ADD, this.handleFeatureAdd_, false, this);
 ...
 * @private
 */
kworks.interaction.Downwid.prototype.addFeature_ = function(feature) {
 ...
 * @private
 */
kworks.interaction.Downwid.prototype.willModifyFeatures_ = function(evt) {
	if (!this.modified_) {
		this.modified_ = true;
		this.dispatchEvent(new kworks.interaction.DownwidEvent(
			kworks.interaction.DownwidEventType.DOWNWIDSTART, this.features_, evt));
	}
};
 ...
 * @private
 */
kworks.interaction.Downwid.prototype.removeFeature_ = function(feature) {
 ...
 * @private
 */
kworks.interaction.Downwid.prototype.removeFeatureSegmentData_ = function(feature) {
 ...
 * @inheritDoc
 */
kworks.interaction.Downwid.prototype.setMap = function(map) {
 ...
 * @private
 */
kworks.interaction.Downwid.prototype.handleFeatureAdd_ = function(evt) {
 ...
 * @private
 */
kworks.interaction.Downwid.prototype.handleFeatureChange_ = function(evt) {
 ...
 * @private
 */
kworks.interaction.Downwid.prototype.handleFeatureRemove_ = function(evt) {
 ...
 * @private
 */
kworks.interaction.Downwid.prototype.writeLineStringGeometry_ = function(feature, geometry) {
 ...
 * @private
 */
kworks.interaction.Downwid.prototype.writeMultiLineStringGeometry_ = function(feature, geometry) {
 ...
 * @private
 */
kworks.interaction.Downwid.prototype.createOrUpdateVertexFeature_ = function(coordinates) {
 ...
 * @private
 */
kworks.interaction.Downwid.compareIndexes_ = function(a, b) {
 ...
 * @private
 */
kworks.interaction.Downwid.handleDownEvent_ = function(evt) {
 ...
 * @private
 */
kworks.interaction.Downwid.handleDragEvent_ = function(evt) {
//	this.ignoreNextSingleClick_ = false;
 ...
 * @this {kworks.interaction.Downwid}
 * @private
 */
kworks.interaction.Downwid.handleUpEvent_ = function(evt) {
	this.ignoreNextSingleClick_ = false;
	this.willModifyFeatures_(evt);
	...
	if (vertexFeature) {
		...
		// 하월 생성
		var downwidLine = spatialUtils.createDownwidLine(coordinates, center, 0.5);
		if (downwidLine == null) {
			$.messager.alert("하월 편집", "하월을 추가할 수 없는 위치입니다.");
			return false;
		}
		var newGeom = new ol.geom.LineString(downwidLine);
	...
	if (this.modified_) {
		this.dispatchEvent(new ol.interaction.ModifyEvent(
			kworks.interaction.DownwidEventType.DOWNWIDEND, this.features_, evt));
		this.modified_ = false;
	}
 ...
 * @api
 */
kworks.interaction.Downwid.handleEvent = function(mapBrowserEvent) {
	...
	if (this.vertexFeature_ && this.deleteCondition_(mapBrowserEvent)) {
		if (mapBrowserEvent.type != ol.MapBrowserEvent.EventType.SINGLECLICK || !this.ignoreNextSingleClick_) {
		    ...
		    this.dispatchEvent(new kworks.interaction.DownwidEvent(
	    		kworks.interaction.DownwidEventType.DOWNWIDEND, this.features_, mapBrowserEvent));
		      	this.modified_ = false;
	    } 
		else {
			handled = true;
 ...
 * @private
 */
kworks.interaction.Downwid.prototype.handlePointerMove_ = function(evt) {
 ...
 * @private
 */
kworks.interaction.Downwid.prototype.handlePointerAtPixel_ = function(pixel, map) {
 ...
 * @private
 */
kworks.interaction.Downwid.prototype.insertVertex_ = function(segmentData, vertex) {
 ...
 * @private
 */
kworks.interaction.Downwid.prototype.removeVertex_ = function() {
 ...
 * @private
 */
kworks.interaction.Downwid.prototype.setGeometryCoordinates_ = function(geometry, coordinates) {
 ...
 * @private
 */
kworks.interaction.Downwid.prototype.updateSegmentIndices_ = function(geometry, index, depth, delta) {
 ...
 */
kworks.interaction.Downwid.getDefaultStyleFunction = function() {
