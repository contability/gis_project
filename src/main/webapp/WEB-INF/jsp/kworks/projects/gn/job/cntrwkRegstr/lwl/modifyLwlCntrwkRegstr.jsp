...
<form id="lwlCntrwkRegstrModifyform" name="lwlCntrwkRegstrModifyform" method="post" enctype="multipart/form-data">
	<div id="lwlCntrwkRegstrModify" class="window_container">
		<div class="window_article">
			...
			<div class="tabs-1">
				<ul class="tab-list-1">
					<li class="active"><a class="tab-control tab_lwlCntrwkRegstr_modify_1" href="#list_tab1">일반사항</a></li>
					<li><a class="tab-control tab_lwlCntrwkRegstr_modify_2" href="#list_tab2">공사관련</a></li>
					<li><a class="tab-control tab_lwlCntrwkRegstr_modify_3" href="#list_tab3">계약사항</a></li>
					<li><a class="tab-control tab_lwlCntrwkRegstr_modify_4" href="#list_tab4">도급자정보</a></li>
					<li><a class="tab-control tab_lwlCntrwkRegstr_modify_5" href="#list_tab5">공사사진</a></li>
				</ul>
			</div>
...
<%-- 				<div class="head_text">- 하자 보수 내역</div>
				<table class="table_text tableSelector">
					<tbody class="tbody_2">
						...
						<c:forEach var="lwlFlawMendngDtls" items="${swgeFlawMendngDtls}">
...
<%-- 				<div class="head_text">- 하도급 내역</div>
			...
			<div class="tab-panel-1" id="list_tab5">
				<table class="table_text tableSelector">
					<tbody class="tbody_2">
						...
						<c:forEach var="resultPhoto" items="${resultPhoto}">
							<tr class="h_80" data-type="lwlCntrwkImage" data-ftr-cde="${resultPhoto.ftrCde}" data-ftr-idn="${resultPhoto.ftrIdn}" data-image-no="${resultPhoto.imageNo}">
								<td>
				...
				<div class="button_flat_mar">
					<button class="btn_photo_lwlCntrwkRegstrAdd button_flat_small btn_grey">내역등록</button>
				</div>
			</div>
		</div>
		<div class="window_footer">
			<div class="button_flat">
				<button class="btn_save_lwlCntrwkRegstrModify button_flat_normal btn_blue">저장</button>
			</div>
		</div>
	</div>
</form>