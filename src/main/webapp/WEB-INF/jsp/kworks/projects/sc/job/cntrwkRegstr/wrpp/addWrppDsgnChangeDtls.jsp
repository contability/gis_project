...
<form id="addWrppDsgnChangeDtls" name="addWrppDsgnChangeDtls" method="post" enctype="multipart/form-data">
	<div class="window_container">
		...
		<div class="window_footer">
			...
			<button class="btn_save_wrppDsgnChangeDtlsAdd button_flat_normal btn_blue">저장</button>
		</div>
	</div>
</form>
