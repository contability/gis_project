...
<script type="text/javascript" src="<c:url value='/js/kworks/deptManage/export.js' />"></script>
		...
		<table class="tbl_export_list" >
			...
			<tbody>
				<c:forEach var="row" items="${rows}" varStatus="status">
					<tr data-export-no="${row.exportNo}" data-export-ty="${row.exportTy}">
						<td>
...
<div id="div_export_detail" class="div_modal" title="내보내기 상세정보">
	<form method="post">
    	<fieldset>
    		<input type="hidden" name="exportNo" value="" />
    		<div>
...
<div id="div_export_return" class="div_modal" title="반려">
	<form method="post" action="<c:url value='/manage/dept/export/add.do' />">
    	<fieldset>
    		<input type="hidden" name="exportNo" value="" />
    		<div>
    			<span class="title">
