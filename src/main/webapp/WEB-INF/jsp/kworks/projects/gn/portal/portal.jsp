...
<head>
	...
	<c:set var="isPledge"><spring:message code="Extensions.Pledge.UseAt"/></c:set>
	...
	<link type="text/css" rel="stylesheet" href="<c:url value='/css/${prjCode }/common/cmmnProp.css'/>">
	...
	<script type="text/javascript">
		var EXTENSIONS = {
				...
				IS_PLEDGE : <spring:message code='Extensions.Pledge.UseAt' text="false"/>
	...
	<!-- kworks -->
	<script type="text/javascript" src="<c:url value='/js/${prjCode }/props/common.js' />"></script>
	...
	<script type="text/javascript" src="<c:url value='/js/kworks/window/window.js'/>"></script>
	<script type="text/javascript" src="<c:url value='/js/kworks/window/pledge.js'/>"></script>
...
<body>
			...
			<div class="slider bd_t_blue4 bd_b_gray3">
				<div class="slideMap m_auto">
					<ul class="kworksMainImg">
						<li>
							<img src="<c:url value='/images/${prjCode}/portal/main_1.png' />" alt="강릉 이미지 1" />
						</li>
						<li>
							<img src="<c:url value='/images/${prjCode}/portal/main_2.png' />" alt="강릉 이미지 2" />
						</li>
						<li>
							<img src="<c:url value='/images/${prjCode}/portal/main_3.png' />" alt="강릉 이미지 3" />
						</li>
					</ul>
				</div>
			</div>
	...
	<!-- 서약서 -->
	<c:if test="${isPledge eq true}">
		<div id="div_pledge" class="div_modal">
			<jsp:include page="/WEB-INF/jsp/kworks/projects/${prjCode}/window/pledge.jsp" flush="true" />
		</div>
	</c:if>
	
	<!-- 공유재산 알림  -->
	<div id="acin_notification_prop" class="notification_prop">
		<div>지번불부합 공유재산이 [<span id="acin_notification_prop_total"></span>] 건이 확인됩니다.</div>
	</div>
	
	<div id="acin_notification_loan" class="notification_prop">
		<div>대부기간 만료 임박 [<span id="acin_notification_loan_count"></span>]건이 확인됩니다.</div>
	</div>
