...
<form id="addSwgeDsgnChangeDtls" name="addSwgeDsgnChangeDtls" method="post" enctype="multipart/form-data">
	<div class="window_container">
		...
		<div class="window_footer">
			...
			<button class="btn_save_swgeDsgnChangeDtlsAdd button_flat_normal btn_blue">저장</button>
		</div>
	</div>
</form>
