...
ftpParameter.setFtpAccount("aaa");               //ID
ftpParameter.setFtpPassword("aaa");              //PASSWORD
ftpParameter.setFilePaths("c:\\temp1\\");
ftpParameter.setFileNames("font.crf");
ftpParameter.setUploadFtpPaths("/test");     //전송할 위치
ftpParameter.setEncoding("UTF-8");  //전송할 인코딩 설정	 
