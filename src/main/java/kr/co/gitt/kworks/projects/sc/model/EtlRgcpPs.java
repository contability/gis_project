...
public class EtlRgcpPs {
	...
	// 표고
	private String bseHgt;
	
	// 타원체고
	private String esdHgt;
	...
	public String getBseHgt() {
		return bseHgt;
	}

	public void setBseHgt(String bseHgt) {
		this.bseHgt = bseHgt;
	}

	public String getEsdHgt() {
		return esdHgt;
	}

	public void setEsdHgt(String esdHgt) {
		this.esdHgt = esdHgt;
	}
