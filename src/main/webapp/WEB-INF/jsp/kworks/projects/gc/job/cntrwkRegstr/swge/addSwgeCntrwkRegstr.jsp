...
<form id="addSwgeCntrwkRegstrAddform" name="addSwgeCntrwkRegstrAddform" method="post" enctype="multipart/form-data">
	<div id="swgeCntrwkRegstrAdd" class="window_container">
			...
			<table class="table_text">
				<tbody>
					<tr>
						...
						<th>e호조번호</th>
						<td>
							<input type="text" name="cttNum" class="input_text_w w_150" value="" />
							<button class="btn_eHojoSearch_swgeCntrwkRegstrAdd button_flat_w_h_custom btn_blue w_43 h_21">조회</button>
						</td>
					</tr>
				</tbody>
			</table>
		...
		<div class="window_footer">
			<div class="button_flat">
				<button class="btn_save_swgeCntrwkRegstrAdd button_flat_normal btn_blue">저장</button>
			</div>
		</div>
	</div>
</form>