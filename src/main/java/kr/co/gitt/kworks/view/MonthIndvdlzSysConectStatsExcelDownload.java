...
@Component("monthIndvdlzSysConectStatsExcelDownload")
public class MonthIndvdlzSysConectStatsExcelDownload extends AbstractExcelView {
	...
	protected void buildExcelDocument(Map<String, Object> model, HSSFWorkbook wb, HttpServletRequest req, HttpServletResponse res) throws Exception {
		...
		for(int i=0; i < categories.size(); i++ ) {
			...
			cell.setCellValue(String.valueOf(categories.get(i).get("totalCount")));
