...
<form id="modifyRdtOcdrDtModifyform" name="modifyRdtOcdrDtModifyform" method="post" enctype="multipart/form-data">
	<div id="modifyRdtOcdrDtRegstr" class="window_container">
		<div class="window_article">
			...
			<table class="table_text">
				<tbody>
					...
					<tr>
						<th>취하신청일</th>
						<td colspan="2"><input type="text" class="easyui-datebox"
							name="pmtYmd" path="pmtYmd" style="width: 99%"
							value="${result.pmtYmd}" /></td>
						<th>연락처</th>
						<td colspan="2"><input type="text" class="easyui-textbox"
