 ...
 * @since 3.0
 */
public class KworksCoMappingJacksonJsonView extends AbstractView {
	 ...
	 */
	public KworksCoMappingJacksonJsonView() {
	...
	protected void renderMergedOutputModel(Map model, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		provider.setNullValueSerializer(new KworksCoNulltoEmptyStringSerializer());
