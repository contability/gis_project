...
<form id="mofidyPhotoForm" name="modifyPhotoForm" method="post" enctype="multipart/form-data" action="<c:url value='/ctrlpnt/updatePhoto.do' />">
			...
			<table id="tablePhoto" class="table_text">
				<tbody>
					...
					<tr>
						<th>제목</th>
						<td>
							<input type="text" class="easyui-textbox" name="imageCn" style="width:99%" value="${image.imageCn }"/>
						</td>
					</tr>
					<tr>
