...
<form id="addPhotoForm" name="addPhotoForm" method="post" enctype="multipart/form-data" action="<c:url value='/policy/insertPhoto.do' />">
				...
				<tbody>
					...
					<tr>
						...
						<td>
							...
							<select name="imageSj" class="w100 easyui-combobox">
									<option value="PAI001">위치도</option>
									<option value="PAI002">사진</option>
									<option value="PAI003">설계서</option>
									<option value="PAI004">도면</option>
									<option value="PAI005">기타</option>
