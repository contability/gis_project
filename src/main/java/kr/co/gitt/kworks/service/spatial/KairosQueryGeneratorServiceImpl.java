...
public class KairosQueryGeneratorServiceImpl implements QueryGeneratorService {
	...
	public String createGeometrySqlByWkt(String wkt) {
		...
		StringBuffer sql = new StringBuffer();
		sql.append("ST_GEOMFROMTEXT('").append(wkt).append("', ").append(projection).append(")");
		return sql.toString();
	}
	...
	public String createSelctPagingSql(String selectSql, SpatialSearchDTO spatialSearchDTO) {
		...
		sql.append("') T2 WHERE RNUM > '").append(spatialSearchDTO.getFirstIndex()).append("'");
		return sql.toString();
	}
	...
	public String createSelctPagingSql(String selectSql, PlanRoadSearchDTO searchDTO) {
		...
		sql.append("') T2 WHERE RNUM > '").append(searchDTO.getFirstIndex()).append("'");
		return sql.toString();
	}
