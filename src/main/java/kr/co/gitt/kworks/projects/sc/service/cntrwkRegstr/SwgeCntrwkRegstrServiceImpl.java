...
import kr.co.gitt.kworks.projects.sc.mappers.SwtChngDtMapper;
import kr.co.gitt.kworks.projects.sc.mappers.SwtConsMaMapper;
import kr.co.gitt.kworks.projects.sc.mappers.SwtCostDtMapper;
import kr.co.gitt.kworks.projects.sc.mappers.SwtFlawDtMapper;
import kr.co.gitt.kworks.projects.sc.mappers.SwtSubcDtMapper;
import kr.co.gitt.kworks.projects.sc.model.SwtChngDt;
import kr.co.gitt.kworks.projects.sc.model.SwtConsMa;
import kr.co.gitt.kworks.projects.sc.model.SwtCostDt;
import kr.co.gitt.kworks.projects.sc.model.SwtFlawDt;
import kr.co.gitt.kworks.projects.sc.model.SwtSubcDt;
...
public class SwgeCntrwkRegstrServiceImpl implements SwgeCntrwkRegstrService {
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.sc.service.cntrwkRegstr.CntrwkRegstrService#listSwge(kr.co.gitt.kworks.projects.sc.model.SwtConsMa)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.sc.service.cntrwkRegstr.CntrwkRegstrService#selectOne(java.lang.String)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.sc.service.cntrwkRegstr.CntrwkRegstrService#modifySwgeCntrwkRegstr(kr.co.gitt.kworks.projects.sc.model.SwtConsMa)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.sc.service.cntrwkRegstr.CntrwkRegstrService#addSwgeCntrwkRegstr(kr.co.gitt.kworks.projects.sc.model.SwtConsMa)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.sc.service.cntrwkRegstr.CntrwkRegstrService#listSwgeFlawMendngDtls(kr.co.gitt.kworks.projects.sc.model.SwtFlawDt)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.sc.service.cntrwkRegstr.CntrwkRegstrService#selectOneSwgeFlawMendngDtls(java.lang.Long, java.lang.Long)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.sc.service.cntrwkRegstr.CntrwkRegstrService#modifySwgeFlawMendngDtls(kr.co.gitt.kworks.projects.sc.model.SwtFlawDt)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.sc.service.cntrwkRegstr.CntrwkRegstrService#addSwgeFlawMendngDtls(kr.co.gitt.kworks.projects.sc.model.SwtFlawDt)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.sc.service.cntrwkRegstr.CntrwkRegstrService#removeSwgeFlawMendngDtls(java.lang.Long)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.sc.service.cntrwkRegstr.CntrwkRegstrService#listSwgeCntrwkCtPymntDtls(kr.co.gitt.kworks.projects.sc.model.SwtCostDt)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.sc.service.cntrwkRegstr.CntrwkRegstrService#selectOneSwgeCntrwkCtPymntDtls(java.lang.Long, java.lang.Long)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.sc.service.cntrwkRegstr.CntrwkRegstrService#modifySwgeCntrwkCtPymntDtls(kr.co.gitt.kworks.projects.sc.model.SwtCostDt)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.sc.service.cntrwkRegstr.CntrwkRegstrService#addSwgeCntrwkCtPymntDtls(kr.co.gitt.kworks.projects.sc.model.SwtCostDt)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.sc.service.cntrwkRegstr.CntrwkRegstrService#removeSwgeCntrwkCtPymntDtls(java.lang.Long)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.sc.service.cntrwkRegstr.CntrwkRegstrService#listSwgeDsgnChangeDtls(kr.co.gitt.kworks.projects.sc.model.SwtChngDt)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.sc.service.cntrwkRegstr.CntrwkRegstrService#selectOneSwgeDsgnChangeDtls(java.lang.Long, java.lang.Long)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.sc.service.cntrwkRegstr.CntrwkRegstrService#modifySwgeDsgnChangeDtls(kr.co.gitt.kworks.projects.sc.model.SwtChngDt)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.sc.service.cntrwkRegstr.CntrwkRegstrService#addSwgeDsgnChangeDtls(kr.co.gitt.kworks.projects.sc.model.SwtChngDt)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.sc.service.cntrwkRegstr.CntrwkRegstrService#removeSwgeDsgnChangeDtls(java.lang.Long)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.sc.service.cntrwkRegstr.CntrwkRegstrService#listSwgeSubcntrDtls(kr.co.gitt.kworks.projects.sc.model.SwtSubcDt)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.sc.service.cntrwkRegstr.CntrwkRegstrService#selectOneSwgeSubcntrDtls(java.lang.Long, java.lang.Long)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.sc.service.cntrwkRegstr.CntrwkRegstrService#modifySwgeSubcntrDtls(kr.co.gitt.kworks.projects.sc.model.SwtSubcDt)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.sc.service.cntrwkRegstr.CntrwkRegstrService#addSwgeSubcntrDtls(kr.co.gitt.kworks.projects.sc.model.SwtSubcDt)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.sc.service.cntrwkRegstr.CntrwkRegstrService#removeSwgeSubcntrDtls(java.lang.Long)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.sc.service.cntrwkRegstr.SwgeCntrwkRegstrService#addSwgeCntrwkRegstrPhoto(kr.co.gitt.kworks.model.KwsImage, org.springframework.web.multipart.MultipartRequest)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.sc.service.cntrwkRegstr.SwgeCntrwkRegstrService#modifySwgeCntrwkRegstrPhoto(kr.co.gitt.kworks.model.KwsImage, org.springframework.web.multipart.MultipartRequest)
	/////////////////////////////////////////////
	@Override
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.sc.service.cntrwkRegstr.SwgeCntrwkRegstrService#searchSpatial(java.lang.Long)
	/////////////////////////////////////////////
	@Override
