...
<form id="modifyRoadDsgnChangeDtls" name="modifyRoadDsgnChangeDtls" method="post" enctype="multipart/form-data">
	<div class="window_container">
		...
		<div class="window_footer">
			...
			<button class="btn_save_roadDsgnChangeDtlsModify button_flat_normal btn_blue">저장</button>
			<button class="btn_save_roadDsgnChangeDtlsRemove button_flat_normal btn_blue">삭제</button>
		</div>
	</div>
</form>
