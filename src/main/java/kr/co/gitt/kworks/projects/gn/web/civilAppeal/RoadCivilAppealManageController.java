...
import kr.co.gitt.kworks.projects.gn.service.civilAppeal.RoadCivilAppealService;
...
public class RoadCivilAppealManageController {
	...
	public String searchRoadCivilAppealPage(RdtRserMa rdtRserMa, Model model) {
		...
		// 도로민원구분
		kwsDomnCode.setDomnId("KWS-0047");
		...
		return "/projects/gn/job/civilAppeal/road/searchRoadCivilAppeal";
	}
