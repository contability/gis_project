var COMMON = {
	...
	/// 국토계획/교통시설(도시계획도로, 도로구간) 테이블 명
	CITYPLN_ROAD : "LT_C_UQ161",
	
	/// 출력영역 미리보기 레이어
	PRINT_AREA_PREVIEW_LAYER : "BML_BADM_AS,RDL_RSMN_AS",
	...
	SYMBOLS : [
	    ...
	    "CIRCLE_BLACK.png","CIRCLE_BLUE.png","CIRCLE_GREEN.png","CIRCLE_RED.png"
	]
