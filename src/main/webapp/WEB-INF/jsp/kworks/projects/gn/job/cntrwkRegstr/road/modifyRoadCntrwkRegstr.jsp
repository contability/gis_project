...
<form id="roadCntrwkRegstrModifyform" name="roadCntrwkRegstrModifyform" method="post" enctype="multipart/form-data">
	<div id="roadCntrwkRegstrModify" class="window_container">
		<div class="window_article">
			...
			<div class="tabs-1">
				<ul class="tab-list-1">
					<li class="active"><a class="tab-control tab_roadCntrwkRegstr_modify_1" href="#list_tab1">일반사항</a></li>
					<li><a class="tab-control tab_roadCntrwkRegstr_modify_2" href="#list_tab2">공사관련</a></li>
					<li><a class="tab-control tab_roadCntrwkRegstr_modify_3" href="#list_tab3">계약사항</a></li>
					<li><a class="tab-control tab_roadCntrwkRegstr_modify_4" href="#list_tab4">도급자정보</a></li>
					<li><a class="tab-control tab_roadCntrwkRegstr_modify_5" href="#list_tab5">공사사진</a></li>
				</ul>
			</div>
			<div class="tab-panel-1 active" id="list_tab1">
					...
					<tbody class="tbody_2">
						...
						<c:forEach var="roadFlawMendngDtls" items="${roadFlawMendngDtls}">
							<tr data-type="rdtFlawDt" data-ftr-idn="${roadFlawMendngDtls.ftrIdn}" data-sht-idn="${roadFlawMendngDtls.shtIdn}">
								<td>
									<fmt:parseDate value="${roadFlawMendngDtls.flaYmd}" var="roadFlawMendngDtls_flaYmd" pattern="yyyyMMdd" />
									<fmt:formatDate value="${roadFlawMendngDtls_flaYmd}" pattern="yyyy-MM-dd" />
								</td>
								<td>
									<fmt:parseDate value="${roadFlawMendngDtls.rprYmd}" var="roadFlawMendngDtls_rprYmd" pattern="yyyyMMdd" />
									<fmt:formatDate value="${roadFlawMendngDtls_rprYmd}" pattern="yyyy-MM-dd" />
								</td>
				...
				<div class="button_flat_mar">
					<button class="btn_save_roadFlawMendngDtlsAdd button_flat_normal btn_blue">내역등록</button>
				</div>
			</div>
			<div class="tab-panel-1" id="list_tab2">
						...
						<tbody class="tbody_2">
							...
							<c:forEach var="roadCntrwkCtPymntDtls" items="${roadCntrwkCtPymntDtls}">
								<tr data-type="rdtCostDt" data-ftr-idn="${roadCntrwkCtPymntDtls.ftrIdn}" data-sht-idn="${roadCntrwkCtPymntDtls.shtIdn}">
									...
									<td>
										<fmt:parseDate value="${roadCntrwkCtPymntDtls.payYmd}" var="roadCntrwkCtPymntDtls_payYmd" pattern="yyyyMMdd" />
										<fmt:formatDate value="${roadCntrwkCtPymntDtls_payYmd}" pattern="yyyy-MM-dd" />
									</td>
									<td>
					...
					<div class="button_flat_mar">
						<button class="btn_save_roadCntrwkCtPymntDtlsAdd button_flat_normal btn_blue">내역등록</button>
					</div>
				</div>
					...
					<tbody class="tbody_2">
						...
						<c:forEach var="roadDsgnChangeDtls" items="${roadDsgnChangeDtls}">
							<tr data-type="rdtChngDt" data-ftr-idn="${roadDsgnChangeDtls.ftrIdn}" data-sht-idn="${roadDsgnChangeDtls.shtIdn}">
								<td>
									<fmt:parseDate value="${roadDsgnChangeDtls.chgYmd}" var="roadDsgnChangeDtls_chgYmd" pattern="yyyyMMdd" />
									<fmt:formatDate value="${roadDsgnChangeDtls_chgYmd}" pattern="yyyy-MM-dd" />
								</td>
								<td>
				...
				<div class="button_flat_mar">
					<button class="btn_save_roadDsgnChangeDtlsAdd button_flat_normal btn_blue">내역등록</button>
				</div>
			</div>
			<div class="tab-panel-1" id="list_tab1">
				...
				<div class="button_flat_mar">
					<button class="btn_save_roadSubcntrDtlsAdd button_flat_normal btn_blue">내역등록</button>
				</div>
			</div>
			<div class="tab-panel-1" id="list_tab5">
				...
				<div class="button_flat_mar">
					<button class="btn_photo_roadCntrwkRegstrAdd button_flat_small btn_grey">내역등록</button>
				</div>
			</div>
		</div>
		<div class="window_footer">
			<div class="button_flat">
				<button class="btn_save_roadCntrwkRegstrModify button_flat_normal btn_blue">저장</button>
			</div>
		</div>
	</div>
</form>