...
var highlightOousObj = {
	...
	init : function() {
		...
		cmmnOccpObj.view.getMap().addLayer(yellowLayer);
		...
		cmmnOccpObj.view.getMap().addLayer(orangeLayer);
		...
		cmmnOccpObj.view.getMap().addLayer(redLayer);
	},
	...
	showFeatures : function(className, source, features, isMove, options) {
		...
		if(options && options.projection) {
			mapProjection = cmmnOccpObj.view.getMap().getView().getProjection();
		}
	...
	moveFeatures : function(features, options) {
		var map = cmmnOccpObj.view.getMap();
		var max = [];
