 ...
 */
public class KworksCoXssChnageRequest extends HttpServletRequestWrapper {
    
    Logger logger = LoggerFactory.getLogger(getClass());
    public KworksCoXssChnageRequest(HttpServletRequest request) {
        super(request);
    }
