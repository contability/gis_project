...
<div id="searchWrppCivilAppeal" class="window_container">
		...
		<table class="table_text">
			<tbody>
				...
				<tr>
					...
					<th>민원지<br>행정동</th>
					<td>
						<form:select class="input_text" name="aplHjd" path="aplHjd" >
							<form:option value="" label="전체"/>
							<form:options items="${aplHjd}" itemValue="codeId" itemLabel="codeNm" />
						</form:select>
					</td>
				</tr>
				<tr>
	...
	<div class="window_footer">
		<div class="button_flat">
			<button class="a_reset_wrppCivilAppealSearch button_flat_normal btn_blue">초기화</button>
			<button class="a_search_wrppCivilAppealSearch button_flat_normal btn_blue">검색</button>
		</div>
	</div>
</div>
