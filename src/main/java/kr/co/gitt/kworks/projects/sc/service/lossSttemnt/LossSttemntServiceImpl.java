package kr.co.gitt.kworks.projects.sc.service.lossSttemnt;
...
import kr.co.gitt.kworks.projects.sc.mappers.EttLscpDtMapper;
...
/// kr.co.gitt.kworks.projects.sc.service.lossSttemnt \n
...
public class LossSttemntServiceImpl implements LossSttemntService {
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.sc.service.lossSttemnt.LossSttemntService#listLossSttemnt(kr.co.gitt.kworks.projects.sc.model.EttLscpDt)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.sc.service.lossSttemnt.LossSttemntService#selectOneLossSttemnt(kr.co.gitt.kworks.projects.sc.dto.LossSttemntDTO)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.sc.service.lossSttemnt.LossSttemntService#addLossSttemnt(kr.co.gitt.kworks.projects.sc.model.EttLscpDt)
	/////////////////////////////////////////////
