...
<form id="addLwlCntrwkRegstrAddform" name="addLwlCntrwkRegstrAddform" method="post" enctype="multipart/form-data">
	<div id="lwlCntrwkRegstrAdd" class="window_container">
		...
		<div class="window_footer">
			<div class="button_flat">
				<button class="btn_save_lwlCntrwkRegstrAdd button_flat_normal btn_blue">저장</button>
			</div>
		</div>
	</div>
</form>