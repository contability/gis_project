	...
	<div id="wrap">
		...
		<div id="container">
				...
				<div class="slideMap m_auto">
					<div class="div_main_image">
						<ul id="portal_main_image_slider">
							<li>
								<img src="<c:url value='/images/${prjCode}/portal/main_1.png' />" alt="양양 이미지 1" />
							</li>
							<li>
								<img src="<c:url value='/images/${prjCode}/portal/main_2.png' />" alt="양양 이미지 2" />
							</li>
							<li>
								<img src="<c:url value='/images/${prjCode}/portal/main_3.png' />" alt="양양 이미지 3" />
							</li>
							<li>
								<img src="<c:url value='/images/${prjCode}/portal/main_4.png' />" alt="양양 이미지 4" />
							</li>
							<li>
								<img src="<c:url value='/images/${prjCode}/portal/main_5.png' />" alt="양양 이미지 5" />
							</li>
							<li>
								<img src="<c:url value='/images/${prjCode}/portal/main_6.png' />" alt="양양 이미지 6" />
							</li>
							<li>
								<img src="<c:url value='/images/${prjCode}/portal/main_7.png' />" alt="양양 이미지 7" />
							</li>
							<li>
								<img src="<c:url value='/images/${prjCode}/portal/main_8.png' />" alt="양양 이미지 8" />
							</li>
						</ul>
					</div>
				</div>
			...
			<div class="w100 bg_f2">
				...
				<div class="survice2 t_a_c" style="width:1175px;">
<%-- 					<c:if test="${fn:length(sysAuthorList) > 5}">
 ...
 --%>					<div class="f_l w_1000" style="width:1175px;">
