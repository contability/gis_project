...
import kr.co.gitt.kworks.projects.dh.service.civilAppeal.SwgeCivilAppealService;
...
public class SwgeCivilAppealManageController {
	...
	public String searchSwgeCivilAppealPage(SwtSserMa swtSserMa, Model model) {
		...
		// 하수민원구분
		kwsDomnCode.setDomnId("KWS-1157");
		...
		return "/projects/dh/job/civilAppeal/swge/searchSwgeCivilAppeal";
	}
