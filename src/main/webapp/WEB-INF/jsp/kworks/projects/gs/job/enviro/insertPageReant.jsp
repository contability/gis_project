			...
			<table id="tableReaatEnviroInsert" class="table_text">
				<tbody>
					<tr>
						<th>관리번호</th>
						<td colspan="5">
						<input type="text" class="easyui-textbox" id="expIdn" name="expIdn" style="width:99%"/>
						</td>
					</tr>
					<tr>
						<th>작업내용</th>
						<td colspan="5">
						<input type="text" class="easyui-textbox" name="jobNote" style="width:99%"/>
						</td>
					<tr>
					<tr>
						<th>주소</th>
					...
					<tr>
						<th>작업인원</th>
						<td colspan="2">
						<input type="text" class="easyui-numberspinner" name="jobPers" style="width:99%"/>
						</td>
						<th>작업유형</th> <!-- 소수점박스 2자리 -->
						<td colspan="2">
						<!-- <input type="text" class="easyui-textbox" name="jobType" style="width:99%"/> -->
						<select name="jobType" id="jobType" class="easyui-combobox" style="width:99%">
								<option value="REM001">제거작업</option>
								<option value="REM002">제거작업(예초기)</option>
								<option value="REM003">식제작업</option>
								<option value="REM004">서식지조사</option>
						</select>
						</td>
					</tr>
					<tr>
						<th>작업일</th> <!-- 날짜박스 -->
						<td colspan="2">
						<input type="text" class="easyui-datebox" name="jobDate" style="width:99%"/>
						</td>
					...
					<tr>
						<th>특이사항</th>
						<td colspan="5">
						<input type="text" class="easyui-textbox" name="etcNote" style="width:99%"/>
						</td>
					</tr>
				</tbody>
			</table>
