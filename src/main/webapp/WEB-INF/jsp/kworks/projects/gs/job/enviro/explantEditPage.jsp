...
<div class="div_window_explantedit">
	...
	<p class="over_h pa_r_10 ma_b_10">
		<a href="#" id="a_edit_regist"><img class='edit_toggle_regist' src="<c:url value='/images/kworks/map/skin2/new_register_off.png'/>" alt="신규등록" title="신규등록"  /></a>
		<a href="#" id="a_edit_select"><img class='edit_toggle_select' src="<c:url value='/images/kworks/map/skin2/btn_select3_off.png'/>" alt="선택" title="선택"  /></a>
	</p>
	...
	<div id="div_edit_detail" class="display_n">
		...
		<p class="over_h ma_b_10 bd_t_c pa_t_10 ma_t_15">
			<span class="f_l">
				<a href="#" id="a_edit_draw"><img class='edit_toggle_draw' src="<c:url value='/images/kworks/map/skin2/btn_draw_off.png'/>" alt="그리기" title="그리기" ></a>
				<a href="#" id="a_edit_move"><img class='edit_toggle_move' src="<c:url value='/images/kworks/map/skin2/transfer_off.png'/>" alt="이동" title="이동" /></a>
			</span>
			<span class="f_r">
