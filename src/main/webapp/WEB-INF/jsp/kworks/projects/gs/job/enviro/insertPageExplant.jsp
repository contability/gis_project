...
<%-- <form id="enviroinsertForm" name="enviroinsertForm" method="post" enctype="multipart/form-data"> --%>
	<div id="enviroModify" class="window_container">
		<div class="window_article">
			...
			<table id="tableEnviroInsert" class="table_text">
				<tbody>
					<tr>
						<th>조사대상</th>
						<td colspan="2">
						<input type="text" class="easyui-textbox" name="expType" style="width:99%"/>
						</td>
						<th>조사자</th>
						<td colspan="2">
						<input type="text" class="easyui-textbox" name="invNam" style="width:99%"/>
						</td>
					<tr>
					<tr>
						<th>조사장소</th>
					...
					<tr>
						<th>분포지 유형</th>
						<td colspan="5">
						<input type="text" class="easyui-textbox" name="disType" style="width:99%"/>
						</td>
					</tr>
					<tr>
						<th>조사일</th> <!-- 날짜박스 -->
						<td colspan="2">
						<input type="text" class="easyui-datebox" name="invDate" style="width:99%"/>
						</td>
						
						<th>생육단계</th>
						<td colspan="2">
						<input type="text" class="easyui-textbox" name="expStep" style="width:99%"/>
						</td>
					</tr>
					<tr>
						<th>분포 밀도</th>
						<td colspan="2"> <!-- 숫자박스 -->
						<input type="text" class="easyui-numberspinner" name="disDens" style="width:99%"/>
						</td>
						<th>평균 키</th>
						<td colspan="2"> <!-- 소수점2자리 -->
						<input type="text" class="easyui-numberbox" name="expSize" style="width:99%"/>
						</td>
					</tr>
					<tr>
						<th>특이사항</th>
						<td colspan="5">
						<input type="text" class="easyui-textbox" name="invNote" style="width:99%"/>
						</td>
					</tr>
