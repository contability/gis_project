	...
	<div id="wrap">
		...
		<div id="container">
			...
			<div class="slider bd_t_blue4 bd_b_gray3">
				<div class="div_main_background_image">
				</div>
				<div class="slideMap m_auto">
					<div class="div_main_background_image_logo">
						<img src="<c:url value='/images/ss/portal/main_background.png' />" />
					</div>
					<div class="div_main_image">
						<ul id="portal_main_image_slider">
							<li>
								<img src="<c:url value='/images/ss/portal/main_1.png' />" alt="서산 이미지 1" />
							</li>
							<li>
								<img src="<c:url value='/images/ss/portal/main_2.png' />" alt="서산 이미지 2" />
							</li>
							<li>
								<img src="<c:url value='/images/ss/portal/main_3.png' />" alt="서산 이미지 3" />
							</li>
							<li>
								<img src="<c:url value='/images/ss/portal/main_4.png' />" alt="서산 이미지 4" />
							</li>
							<li>
								<img src="<c:url value='/images/ss/portal/main_5.png' />" alt="서산 이미지 5" />
							</li>
							<li>
								<img src="<c:url value='/images/ss/portal/main_6.png' />" alt="서산 이미지 6" />
							</li>
							<li>
								<img src="<c:url value='/images/ss/portal/main_7.png' />" alt="서산 이미지 7" />
							</li>
							<li>
								<img src="<c:url value='/images/ss/portal/main_8.png' />" alt="서산 이미지 8" />
							</li>
							<li>
								<img src="<c:url value='/images/ss/portal/main_9.png' />" alt="서산 이미지 9" />
							</li>
						</ul>
					</div>
				</div>
			...
			<div class="w100 bg_f2">
				...
				<div class="survice2 t_a_c">
					<div class="f_l w_1000" style="display:inline-block; float:none;">
										...
										<li>
											<c:if test="${sysAuthor.authorAt eq 'Y'}">
												<a href="<c:url value='/main.do?sysId=${sys.sysId}' />">
													<img class="mainSys cursor_point" src="<c:url value='/images/${prjCode}/portal/sys_${sys.sysNm}_off.png' />" />
												</a>
											</c:if>
