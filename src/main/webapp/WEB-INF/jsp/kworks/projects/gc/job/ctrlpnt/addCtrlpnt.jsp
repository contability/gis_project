		...
		<table class="cmmTable v2 ma_b_30" summary="기준점 정보 관련 테이블">
			...
			<tbody>
				...
				<tr>
					...
					<td><input type="text" name="decNum"class="inputText w100" maxlength="8" /></td>
				</tr>
				<tr>
					...
					<td colspan="3">
						...
						<select name="bjdCde" class="selectBox w_90">
							<c:forEach items="${bjdCde}" var="bjdCde" varStatus="status">
								<option value="${bjdCde.codeId}">${bjdCde.codeNm}</option>
							</c:forEach>
						</select>
		...
		<table class="cmmTable v2 ma_b_30" summary="성과 정보 관련 테이블">
			...
			<tbody>
				<tr>
					...
					<td colspan="3"><input type="text" name="pntNam" class="inputText w100" maxlength="10" /></td>
				</tr>
				<tr>
					<th scope="row">경도(E)</th>
					<td><input type="text" name="ngwY" class="inputText w100" maxlength="20" /></td>
					<th scope="row">위도(N)</th>
					<td><input type="text" name="ngwX" class="inputText w100" maxlength="20" /></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><input type="text" name="esdHgt" class="inputText w100" maxlength="10" /></td>		
					<th scope="row">정표고</th>	
