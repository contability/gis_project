...
public class CntrwkRegstrDTO extends SearchDTO {
	...
	/// 준공일자 min - 급수공사대장
	private String fnsYmdMin;
	
	/// 준공일자 max - 급수공사대장
	private String fnsYmdMax;
	...
	public String getFnsYmdMin() {
		return fnsYmdMin;
	}

	public void setFnsYmdMin(String fnsYmdMin) {
		this.fnsYmdMin = fnsYmdMin;
	}

	public String getFnsYmdMax() {
		return fnsYmdMax;
	}

	public void setFnsYmdMax(String fnsYmdMax) {
		this.fnsYmdMax = fnsYmdMax;
	}
