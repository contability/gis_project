package kr.co.gitt.kworks.contact.eais.service;
...
/////////////////////////////////////////////
/// @class BildngPrmisnRegstrService
/// kr.co.gitt.kworks.cntc.service.eais \n
///   ㄴ BildngPrmisnRegstrService.java
/// @section 클래스작성정보
///    |    항  목       |      내  용       |
///    | :-------------: | -------------   |
///    | Company | (주)GittGDS |    
///    | Author | GittGDS_YJG |
///    | Date | 2017. 1. 2. 오후 2:51:39 |
///    | Class Version | v1.0 |
///    | 작업자 | GittGDS_YJG, Others... |
/// @section 상세설명
/// - 이 클래스는 건축허가대장 서비스 클래스 입니다.
///   -# 
/////////////////////////////////////////////
public interface BildngPrmisnRegstrService {
	...
	/////////////////////////////////////////////
	/// @fn selectOneBildngPrmisnRegstr
