...
<form id="addMesrSgnalSttusExaminHist" name="addMesrSgnalSttusExaminHist" method="post" enctype="multipart/form-data" >
		...
		<table class="cmmTable v2 ma_b_30" summary="기준점 정보 관련 테이블">
			...
			<tbody>
				...
				<tr>
					...
					<td>
						<input type="text" name="rptYmy"class="inputText w100" />
					</td>
					<th scope="row">조사년월일</th>
					<td>
						<input type="text" name="svrYmd"class="inputText easyui-datebox" style="width:153px" maxlength="10" />
					</td>
				</tr>
				<tr>
					...
					<td>
						<input type="text" name="svgNam"class="inputText w100" />
					</td>
				</tr>
				<tr>
					...
					<td>
						<select name="spsCde" class="selectBox w100">
							<c:forEach items="${spsCde}" var="spsCde" varStatus="status">
								<option value="${spsCde.codeId}">${spsCde.codeNm}</option>
							</c:forEach>
						</select>
					</td>
					<th scope="row">조사작성자직급</th>
					<td>
						<input type="text" name="svpPst"class="inputText w100" />
					</td>
				</tr>
				<tr>
					...
					<td>
						<select name="sbsCde" class="selectBox w100">
							<c:forEach items="${sbsCde}" var="sbsCde" varStatus="status">
								<option value="${sbsCde.codeId}">${sbsCde.codeNm}</option>
							</c:forEach>
						</select>
					</td>
					<th scope="row">조사작성자성명</th>
					<td>
						<input type="text" name="svpNam"class="inputText w100" />
					</td>
				</tr>
				<tr>
					...
					<td colspan="3">
						<select name="dcsCde" class="selectBox w100">
							<c:forEach items="${dcsCde}" var="dcsCde" varStatus="status">
								<option value="${dcsCde.codeId}">${dcsCde.codeNm}</option>
							</c:forEach>
						</select>
					</td>
				</tr>
				<tr>
					...
					<td colspan="3">
						<input type="text" name="lndNam"class="inputText w100" />
					</td>
				</tr>
				<tr>
					<th scope="row">토지소유자지번주소</th>
					<td colspan="3">
						<input type="text" name="lndPad"class="inputText w100"/>
					</td>
				</tr>
				<tr>
					<th scope="row">토지소유자도로명주소</th>
					<td colspan="3">
						<input type="text" name="lndRad"class="inputText w100"/>
					</td>
				</tr>
				<tr>
					<th scope="row">비고</th>
					<td colspan="3">
						<textarea name=rmkDes class="textArea w100 h_50"></textarea>
					</td>
				</tr>
			</tbody>
		</table>
	...
	<p class="btnRight v2">
		<a id="a_save_addMesrSgnalSttusExaminHist" href="#" class="btnBlue">저장</a>
	</p>
</form>
