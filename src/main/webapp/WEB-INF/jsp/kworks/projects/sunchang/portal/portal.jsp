...
<head>
	...
	<c:set var="isSurvey"><spring:message code="Extensions.Survey.UseAt" text="false"/></c:set>	<!-- 설문조사 사용 여부 -->
...
<%-- 	<!-- jquery & jeasy-ui -->
 ...
 --%>	
	...
	<script src="<c:url value='/js/kworks/window/survey.js' />" type="text/javascript"></script>
		...
		<div id="container">
				...
				<div class="slideMap m_auto">
					<div class="div_main_image">
						<ul id="portal_main_image_slider">
 							<li>
								<img src="<c:url value='/images/${prjCode}/portal/main_1.png' />" alt="순창 이미지 1" />
							</li>
							<li>
								<img src="<c:url value='/images/${prjCode}/portal/main_2.png' />" alt="순창 이미지 2" />
							</li>
							<li>
								<img src="<c:url value='/images/${prjCode}/portal/main_3.png' />" alt="순창 이미지 3" />
							</li>
						</ul>
					</div>
				</div>
			...
			<div class="slider bd_t_blue4 bd_b_gray3">
				...
				<div class="slideMap m_auto">
					<div class="div_main_image">
						<ul id="portal_main_image_slider">
<%-- 							<li style="float: left; list-style: none; position: relative; width: 300px;">
								<img src="<c:url value='/images/${prjCode}/portal/main_1.png' />" alt="순창 이미지 1" />
							</li>
							<li style="float: left; list-style: none; position: relative; width: 300px;">
								<img src="<c:url value='/images/${prjCode}/portal/main_2.png' />" alt="순창 이미지 2" />
							...
							<%-- <li style="float: left; list-style: none; position: relative; width: 300px;">
								<img src="<c:url value='/images/${prjCode}/portal/main_4.png' />" alt="순창 이미지 4" />
							</li> --%>
						</ul>
					</div>
				</div>
	...
	<!-- 설문 조사  -->
	<c:if test="${isSurvey eq true }">
		<div id="div_survey" class="div_modal" title="설문 조사">
			<jsp:include page="/WEB-INF/jsp/kworks/projects/${prjCode}/window/survey.jsp" flush="true" />
		</div>
	</c:if>
