...
import kr.co.gitt.kworks.projects.gc.mappers.WttSplyMaMapper;
import kr.co.gitt.kworks.projects.gc.model.WttSplyMa;
...
public class WspCntrwkRegstrServiceImpl implements WspCntrwkRegstrService {
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.gc.service.cntrwkRegstr.WspCntrwkRegstrService#listWspCntrwkRegstr(kr.co.gitt.kworks.projects.gc.model.WttSplyMa)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.gc.service.cntrwkRegstr.WspCntrwkRegstrService#selectOneWspCntrwkRegstr(java.lang.Long)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.gc.service.cntrwkRegstr.WspCntrwkRegstrService#modifyWspCntrwkRegstr(kr.co.gitt.kworks.projects.gc.model.WttSplyMa)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.gc.service.cntrwkRegstr.WspCntrwkRegstrService#addWspCntrwkRegstr(kr.co.gitt.kworks.projects.gc.model.WttSplyMa)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.gc.service.cntrwkRegstr.WspCntrwkRegstrService#searchSpatial(java.lang.Long)
	/////////////////////////////////////////////
	@Override
	public List<String> searchSpatial(Long ftrIdn) {
		CmtPrsvHt cmtPrsvHt = new CmtPrsvHt();
		cmtPrsvHt.setCntCde("SA962");
