package kr.co.gitt.kworks.projects.sc.service.ctrlpnt;
...
import kr.co.gitt.kworks.projects.sc.mappers.EtlRgcpPsMapper;
import kr.co.gitt.kworks.projects.sc.model.EtlRgcpPs;
...
/// kr.co.gitt.kworks.projects.sc.service.ctrlpnt \n
...
public class CtrlpntServiceImpl implements CtrlpntService {
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.sc.service.ctrlpnt.CtrlpntService#listCtrlpnt(kr.co.gitt.kworks.projects.sc.model.EtlRgcpPs)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.sc.service.ctrlpnt.CtrlpntService#selectOneCtrlpnt(java.lang.Long)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.sc.service.ctrlpnt.CtrlpntService#modifyCtrlpnt(kr.co.gitt.kworks.projects.sc.model.EtlRgcpPs)
	/////////////////////////////////////////////
	public Integer modifyCtrlpnt(EtlRgcpPs etlRgcpPs, MultipartRequest multipartRequest) throws Exception {
		...
		String nggX = etlRgcpPs.getNggX();
		String nggY = etlRgcpPs.getNggY();
		String wkt = "POINT(" + nggX + " " + nggY + ")";
		etlRgcpPs.setWkt(wkt);
		...
		if(multipartRequest.getFileMap().entrySet() != null) {
			for(Entry<String, MultipartFile> entry : multipartRequest.getFileMap().entrySet()) {
				...
				double lcX = Double.parseDouble(nggX);
				double lcY = Double.parseDouble(nggY);
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.sc.service.ctrlpnt.CtrlpntService#addCtrlpnt(kr.co.gitt.kworks.projects.sc.model.EtlRgcpPs)
	/////////////////////////////////////////////
