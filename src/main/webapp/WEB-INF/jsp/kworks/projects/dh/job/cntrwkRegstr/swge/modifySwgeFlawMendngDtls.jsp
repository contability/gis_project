...
<form id="modifySwgeFlawMendngDtls" name="modifySwgeFlawMendngDtls" method="post" enctype="multipart/form-data">
	<div class="window_container">
		...
		<div class="window_footer">
			<div class="button_flat">
				<button class="btn_save_swgeFlawMendngDtlsModify button_flat_normal btn_blue">저장</button>
				<button class="btn_save_swgeFlawMendngDtlsRemove button_flat_normal btn_blue">삭제</button>
			</div>
		</div>
	</div>
</form>
