...
import kr.co.gitt.kworks.projects.sc.service.civilAppeal.RoadCivilAppealService;
...
public class RoadCivilAppealManageController {
	...
	public String searchRoadCivilAppealPage(RdtRserMa rdtRserMa, Model model) {
		...
		// 도로민원구분
		kwsDomnCode.setDomnId("KWS-0064");
		...
		return "/projects/sc/job/civilAppeal/road/searchRoadCivilAppeal";
	}
