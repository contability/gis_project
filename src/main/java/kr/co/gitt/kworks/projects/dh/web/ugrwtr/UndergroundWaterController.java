package kr.co.gitt.kworks.projects.dh.web.ugrwtr;
...
import kr.co.gitt.kworks.projects.dh.service.ugrwtr.UndergroundWaterService;
...
public class UndergroundWaterController {
	...
	public String pageUndergroundWater(BmlWellPs bmlWellPs, Model model) {
		...
		model.addAttribute("dvopLocN", domnCodeService.listDomnCode(kwsDomnCode));

		// 용도구분
		kwsDomnCode.setDomnId("KWS-0307");
		model.addAttribute("uwaterSrv", domnCodeService.listDomnCode(kwsDomnCode));
		
		return "/projects/dh/job/ugrwtr/listUndergroundWater";
	}
	...
	public String selectOneUndergroundWaterPage(@PathVariable("ftrIdn") Long ftrIdn, BmlWellPs bmlWellPs, Model model){
		...
		model.addAttribute("uwaterDtl", domnCodeService.listDomnCode(kwsDomnCode));
		
		// 사용구분(용도정보)
		kwsDomnCode.setDomnId("KWS-224");
		model.addAttribute("uwaterPot", domnCodeService.listDomnCode(kwsDomnCode));
		
		model.addAttribute("result",undergroundWaterService.selectOne(bmlWellPs));
		return "/projects/dh/job/ugrwtr/viewUndergroundWater";
	}
	...
	public String modifyUndergroundWaterPage(@PathVariable("ftrIdn") Long ftrIdn, BmlWellPs bmlWellps, Model model) {
		...
		model.addAttribute("result",undergroundWaterService.selectOne(bmlWellps));
		return "/projects/dh/job/ugrwtr/modifyUndergroundWater";
	}
	...
	///~~~~~~~~~~~~~
	/////////////////////////////////////////////
	@RequestMapping(value="chckImprmnHist/{ftrIdn}/page.do", method=RequestMethod.GET)
	public String pageUndergroundWaterChckImprmnHist(@PathVariable("ftrIdn") Long ftrIdn, BmlWellCheck bmlWellCheck, Model model) {
		bmlWellCheck.setFtrIdn(ftrIdn);
		...
		return "/projects/dh/job/ugrwtr/listUndergroundWaterChckImprmnHist";
	}
	...
	public String selectOneUndergroundWaterChckImprmnHistPage(@PathVariable("chkIdn") String chkIdn, BmlWellCheck bmlWellCheck, Model model){
		KwsDomnCode kwsDomnCode = new KwsDomnCode();
		kwsDomnCode.setSearchCondition("2");
		...
		return "/projects/dh/job/ugrwtr/modifyUndergroundWaterChckImprmnHist";
	}
	...
	public String modifyUndergroundWaterChckImprmnHist(@PathVariable("chkIdn") String chkIdn, BmlWellCheck bmlWellCheck, Model model) {
	...
	public String removeUndergroundWaterChckImprmnHist(@PathVariable("chkIdn") String chkIdn, Model model) {
	...
	public String pageUndergroundWaterChckImprmnHistAdd(BmlWellCheck bmlWellCheck, Model model){
		...
		kwsDomnCode.setDomnId("KWS-222");
		model.addAttribute("chkCde", domnCodeService.listDomnCode(kwsDomnCode));
		return "/projects/dh/job/ugrwtr/addUndergroundWaterChckImprmnHist";
	}
	...
	///~~~~~~~~~~~~~
	/////////////////////////////////////////////
	@RequestMapping(value="chckImprmnHist/{ftrIdn}/add.do", method=RequestMethod.POST)
	public String addUndergroundWaterChckImprmnHist(@PathVariable("ftrIdn") Long ftrIdn, BmlWellCheck bmlWellCheck, Model model) throws FdlException {
		bmlWellCheck.setFtrIdn(ftrIdn);
