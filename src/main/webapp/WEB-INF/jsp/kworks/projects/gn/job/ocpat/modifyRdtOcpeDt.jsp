...
<form id="modifyRdtOcpeDtModifyform" name="modifyRdtOcpeDtModifyform"
	method="post" enctype="multipart/form-data">
	<div id="modifyOcpeDtRegstr" class="window_container">
				...
				<tbody>
					<tr>
						...
						<td><input type="text" class="w_110 easyui-datebox"
							name="pmtYmd" path="pmtYmd" value="${result.pmtYmd}" />
						</td>
					</tr>
					<tr>
						<th>점용자 성명</th>
					...
					<tr>
						<th>노선번호</th>
						<td colspan="2"><input type="text" class="easyui-textbox"
							name="rotIdn" path="rotIdn" style="width: 99%"
							value="${result.rotIdn}" /></td>
						<th>구간번호</th>
						<td colspan="2"><input type="text" class="easyui-textbox"
							name="secIdn" path="secIdn" style="width: 99%"
							value="${result.secIdn}" /></td>
					</tr>
