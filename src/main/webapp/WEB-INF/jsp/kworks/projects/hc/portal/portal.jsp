		...
		<div id="container">
					...
					<div class="div_main_image">
						<ul id="portal_main_image_slider">
							<li style="float: left; list-style: none; position: relative; width: 300px;">
								<img src="<c:url value='/images/${prjCode}/portal/main_1.jpg' />" alt="화천 이미지 1" />
							</li>
							<li style="float: left; list-style: none; position: relative; width: 300px;">
								<img src="<c:url value='/images/${prjCode}/portal/main_2.jpg' />" alt="화천 이미지 2" />
							</li>
							<li style="float: left; list-style: none; position: relative; width: 300px;">
								<img src="<c:url value='/images/${prjCode}/portal/main_3.jpg' />" alt="화천 이미지 3" />
							</li>
							<li style="float: left; list-style: none; position: relative; width: 300px;">
								<img src="<c:url value='/images/${prjCode}/portal/main_4.jpg' />" alt="화천 이미지 4" />
							</li>
						</ul>
					</div>
				</div>
			...
			<div class="w100 bg_f2">
				...
				<div class="survice2 t_a_c">
					<div class="f_l w_1000" style="float:none; margin:0px auto;">
						<ul id="portal_sys_slider" style="display:inline-block;">
