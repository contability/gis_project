goog.provide('kworks.interaction.DragZoomOut');
...
kworks.interaction.DragZoomOut = function(opt_options) {
...
goog.inherits(kworks.interaction.DragZoomOut, ol.interaction.DragZoom);


/**
 * @inheritDoc
 */
kworks.interaction.DragZoomOut.prototype.onBoxEnd = function() {
  var map = this.getMap();
