...
<script type="text/javascript" src="<c:url value='/js/kworks/manage/log/SysConectLogGroupByDay.js' />"></script>
...
<div class="panel cont">
	...
	<form:form commandName="searchDTO" method="GET">
						...
						<tr>
							...
							<c:forEach items="${sys}" var="sys">
								<td>
									...
									<%-- //day 와 sysId 가 같은 값을 rows에서 찾아서 기본값에 셋팅한다. --%>
									<c:forEach items="${rows}" var="row">
										<c:if test="${row.day eq cnt.day && sys.sysId eq row.sysId}">
		...
		<div id="paginate" align="center">
			<ui:pagination paginationInfo = "${paginationInfo}" type="image" jsFunction="GroupByDayObj.goPage" />
