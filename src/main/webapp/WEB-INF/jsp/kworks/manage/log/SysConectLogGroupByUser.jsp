...
<script type="text/javascript" src="<c:url value='/js/kworks/manage/log/SysConectLogGroupByUser.js' />"></script>
...
<div class="panel cont">
	...
	<form:form commandName="searchDTO" method="GET">
		...
		<div class="div_searchResultInfo">
			<table>
				<thead>
					<tr>
						<td>ID</td>
							...
							<c:forEach items="${sys}" var="sys">
								<td>
									...
									<c:forEach items="${rows}" var="row">
										<c:if test="${row.userId eq cnt.userId && sys.sysId eq row.sysId}">
		...
		<div id="paginate" align="center">
			<ui:pagination paginationInfo = "${paginationInfo}" type="image" jsFunction="GroupByUserObj.goPage" />
