...
<div class="div_window_kras">
	<div class="div_loading">
		<img src="<c:url value='/images/kworks/common/contact-loading.gif' />"
			alt="로딩중" title="로딩중" />
	</div>
	...
	<ul class="div_kras_tab_list tabList">
		...
		<li class="bldg_info"><a href="#"
			data-div-id="div_kras_buld_info">건물정보</a></li>
		<li class="li_bildngPrmisn"><a href="#"
			data-div-id="div_eais_bildngPrmisn_info">건축허가대장</a></li>
	</ul>
	...
	<div id="div_kras_land_info" class="tabCont">
		...
		<c:if test="${ prjCode eq 'ss' or prjCode eq 'yy'}">
			<!-- 토지이동연혁 -->
			<p class="subTitle land_mov_hist">
				<span>토지이동연혁</span>
			</p>
			<table class="cmmTable v3 mod ma_b_30 land_mov_hist"
				summary="토지이동연혁 테이블">
		...
		<table class="cmmTable v4 mod" summary="토지이용계획 테이블">
			...
			<tbody>
				...
				<tr>
					...
					<th scope="row">「국토의 계획 및 이용에 관한 법률」<br />에 따른 지역&#183;지구 등
					</th>
				...
				<tr>
					<th scope="row" colspan="2">「토지이용규제 기본법 시행령」<br />제9조제4항 각 호에
						해당되는 사항
					</th>
				...
				<tr>
					...
					<td colspan="2"><img class="img_land_view_img" alt="도면"
						src="<c:url value='/images/kworks/map/blank.gif' />" /></td>
					<td class="va_t">
						<div class="t_a_c">
							<span>범례</span>
						</div>
						...
						<div class="ma_t_8 t_a_c">
							축척 1 / <input class="txt_land_view_scale" type="text" value="500" />
							<a class="a_apply_land_view_scale" href="#"> <img
								src="<c:url value='/images/kworks/map/common/btn_set.png' />"
								alt="적용" />
							</a>
						</div>
					</td>
				...
				<tr>
					...
					<td colspan="3" class="ucodes"><a href="#"
						class="a_load_ucodes">행위제한 내용 불러오기</a></td>
				</tr>
			</tbody>
		</table>
	</div>
	...
	<div id="div_kras_buld_info" class="tabCont">
		...
		<table class="tbl_kras_bldg_info cmmTable v2 ma_b_30"
			summary="건축물정보 테이블">
			...
			<tbody>
				...
				<tr>
					...
					<td class="vlRatEstmTotarea"></td>
					<th scope="row">건축물수</th>
					<td class="mainBldCnt"></td>
				</tr>
				<tr>
					<th scope="row">건폐율</th>
					<td class="bcRat blr"></td>
					<th scope="row">용적률</th>
					<td class="vlRat"></td>
					<th scope="row">총호수</th>
				...
				<tr>
					...
					<th scope="row">주구조</th>
					<td class="strctCdNm"></td>
					<th scope="row">부속건축물수</th>
					<td class="atchBldCnt"></td>
				</tr>
				<tr>
					<th scope="row">허가일자</th>
					<td class="pmsDay"></td>
					<th scope="row">착공일자</th>
					<td class="stcnsDay"></td>
					<th scope="row">사용승인일자</th>
					<td class="useaprDay"></td>
				</tr>
				<tr>
					<th scope="row">위반건축물 여부</th>
					<td class="violBldYn"></td>
					<th scope="row">특이사항</th>
					<td colspan="3" class="spcmt"></td>
				</tr>
			</tbody>
		</table>
	...
	<div id="div_eais_bildngPrmisn_info" class="tabCont">
		...
		<table class="tbl_eais_bildngPrmisn_info cmmTable v3 mod ma_b_30"
			summary="건축허가대장정보 테이블">
			...
			<tbody>
				...
				<tr>
					<th scope="row">허가번호<br>(연도)
					</th>
					<td class="pmsnoYear"></td>
					<th scope="row">허가번호<br>(기관)
					</th>
					<td class="pmsnoKikCdNm"></td>
					<th scope="row">허가번호<br>(일련번호)
					</th>
				...
				<tr>
					...
					<td colspan="5" class="cnclCaus"></td>
				</tr>
				<tr>
				...
				<tr>
					<th scope="row">가설건축물<br>존치만료일
					</th>
					<td class="tmpbldPrsvExpDay"></td>
					<th scope="row">가설건축물<br>연장차수
					</th>
	...
	<p class="btnRight">
		<a class="land_print btn_print4" href="#"></a> <a
			class="a_close btn_close" href="#"></a>
	</p>
</div>