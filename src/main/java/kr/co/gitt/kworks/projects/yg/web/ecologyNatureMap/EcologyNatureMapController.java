...
import kr.co.gitt.kworks.projects.yg.service.ecologyNatureMap.EcologyNatureMapService;
...
public class EcologyNatureMapController {
	/// 메세지 소스
		...
		public String listLpPaCbndStats(LpPaCbndStats lpPaCbndStats, Model model) {
			model.addAttribute("data", ecologyNatureMapService.list(lpPaCbndStats));
			model.addAttribute("rows", ecologyNatureMapService.list(lpPaCbndStats));
			return "jsonView";
		}
		
		@RequestMapping(value="select.do", method=RequestMethod.GET)
		public String selectLpPaCbndStats(LpPaCbndStats lpPaCbndStats, Model model) {
			model.addAttribute("data", ecologyNatureMapService.select(lpPaCbndStats));
			return "jsonView";
		}
