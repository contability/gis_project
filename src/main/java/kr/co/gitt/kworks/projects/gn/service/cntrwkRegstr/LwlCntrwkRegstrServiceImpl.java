...
import kr.co.gitt.kworks.projects.gn.mappers.LwtDeptMaMapper;
...
///   -# 
/////////////////////////////////////////////
@Service("lwlCntrwkRegstrService")
@Profile({"gn_dev", "gn_oper", "gds_dev", "gds_oper"})
public class LwlCntrwkRegstrServiceImpl implements LwlCntrwkRegstrService {
	...
	// 하수 공사대장 맵퍼
	@Resource
	LwtDeptMaMapper lwtDeptMaMapper;
...
/*	// 하수 공사대장 하자 보수 내역 맵퍼
	...
	// 하수 공사대장 시퀀스 서비스
	@Resource
	EgovIdGnrService lwtDeptMaIdGnrService;
...
/*	// 하수 공사대장 하자보수내역 시퀀스 서비스
	...
	/////////////////////////////////////////////
	public List<LwtDeptMa> listLwlCntrwkRegstr(LwtDeptMa lwtDeptMa){
		return lwtDeptMaMapper.list(lwtDeptMa);
	}
	...
	/////////////////////////////////////////////
	public LwtDeptMa selectOneLwlCntrwkRegstr(Long ftrIdn){
		return lwtDeptMaMapper.selectOne(ftrIdn);
	}
	...
	/////////////////////////////////////////////
	public Integer modifyLwlCntrwkRegstr(LwtDeptMa lwtDeptMa) {
		Integer rowCount = lwtDeptMaMapper.update(lwtDeptMa);
		return rowCount;
	}
	...
	/////////////////////////////////////////////
	public Integer addLwlCntrwkRegstr(LwtDeptMa lwtDeptMa) throws FdlException {
		String ftrCde = "SC951"; 
		Long ftrIdn = lwtDeptMaIdGnrService.getNextLongId();
		
		lwtDeptMa.setFtrCde(ftrCde);
		lwtDeptMa.setFtrIdn(ftrIdn);
		
		Integer rowCount = lwtDeptMaMapper.insert(lwtDeptMa);
		return rowCount;
	}
...
/*	public Integer addSwgeFlawMendngDtls(SwtFlawDt swtFlawDt) throws FdlException {
	...
	/////////////////////////////////////////////
/*	public Integer removeLwlFlawMendngDtls(Long shtIdn) {
...
/*	public Integer removeSwgeSubcntrDtls(Long shtIdn) {
	...
	/////////////////////////////////////////////
	public Integer addLwlCntrwkRegstrPhoto(KwsImage kwsImage, MultipartRequest multipartRequest) throws Exception {
		...
		for(Entry<String, MultipartFile> entry : multipartRequest.getFileMap().entrySet()) {
			...
			if(!multipartFile.isEmpty()) {
				...
				if(StringUtils.equals("lwlCntrwkPhoto", key)) {
					imageDTO.setImageTy(ImageTy.LWL_CNTRWK_PHOTO);
				}
			}
	...
	/////////////////////////////////////////////
	@Override
	public Integer modifyLwlCntrwkRegstrPhoto(KwsImage kwsImage, MultipartRequest multipartRequest) throws Exception {
