...
/////////////////////////////////////////////
/// @class ExportHistManageController
/// kr.co.gitt.kworks.web.manage \n
///   ㄴ ExportHistManageController.java
/// @section 클래스작성정보
///    |    항  목       |      내  용       |
///    | :-------------: | -------------   |
///    | Company | (주)GittGDS |    
///    | Author | "윤중근" |
///    | Date | 2016. 9. 7. 오후 6:00:17 |
///    | Class Version | v1.0 |
///    | 작업자 | "윤중근", Others... |
/// @section 상세설명
/// - 이 클래스는 내보내기 관리이력 클래스 입니다.
///   -# 
/////////////////////////////////////////////
@Controller
@RequestMapping("/manage/exportHist/")
public class ExportHistManageController {
	...
	public String listExportPage(ExportSearchDTO searchDTO, PaginationInfo paginationInfo, Model model) {
		...
		return "/manage/exportHist/listExportHist";
	}
