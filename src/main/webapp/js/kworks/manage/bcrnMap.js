...
var bcrnMapObj = {
	...
	bindEvents : function() {
		...
		// 항목 선택
		$(".tbl_bcrnMap_list tbody tr", that.selector).click(function() {
			var element = $(this);
	...
	clearSelected : function() {
		var that = this;
		$(".tbl_bcrnMap_list tbody tr", that.selector).removeClass("on");
	},
 ...
 * @type {Object}
 */
bcrnMapObj.modifyDialog = {
	
	/**
	 * 선택자
	 */
	selector : "#div_bcrnMap_modify",
	...
	open : function(mapNo) {
		...
		$.get(url).done(function(result) {
			if(result && result.data) {
				...
				$(".mapTitle", that.selector).html(data.title);
