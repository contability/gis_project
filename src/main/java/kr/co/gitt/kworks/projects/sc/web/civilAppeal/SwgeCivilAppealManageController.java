...
import kr.co.gitt.kworks.projects.sc.service.civilAppeal.SwgeCivilAppealService;
...
public class SwgeCivilAppealManageController {
	...
	public String searchSwgeCivilAppealPage(SwtSserMa swtSserMa, Model model) {
		...
		// 하수민원구분
		kwsDomnCode.setDomnId("KWS-0148");
		...
		return "/projects/sc/job/civilAppeal/swge/searchSwgeCivilAppeal";
	}
