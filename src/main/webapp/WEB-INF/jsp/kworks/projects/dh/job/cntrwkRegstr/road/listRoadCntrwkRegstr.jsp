...
<div id="listRoadCntrwkRegstr" class="window_container">
	...
	<div class="window_footer">
		<div class="button_flat">
			<button class="a_reset_roadCntrwkRegstr button_flat_normal btn_blue">초기화</button>
			<button class="a_search_roadCntrwkRegstr button_flat_normal btn_blue">검색</button>
		</div>
	</div>
</div>
