package kr.co.gitt.kworks.projects.gs.model;
...
/////////////////////////////////////////////
/// @class RdtConsMa
/// kr.co.gitt.kworks.projects.yy.model \n
///   ㄴ RdtConsMa.java
/// @section 클래스작성정보
///    |    항  목       |      내  용       |
///    | :-------------: | -------------   |
...
/// @section 상세설명
/// - 이 클래스는 강릉시 도로공사대장 모델 클래스 입니다.
///   -# 
/////////////////////////////////////////////
public class RdtConsMa extends CntrwkRegstrDTO {
	...
	/// 도로 공사사진
	private KwsImage roadCntrwkPhotoImage;
	...
	public KwsImage getRoadCntrwkPhotoImage() {
		return roadCntrwkPhotoImage;
	}

	public void setRoadCntrwkPhotoImage(KwsImage roadCntrwkPhotoImage) {
		this.roadCntrwkPhotoImage = roadCntrwkPhotoImage;
	}
