package kr.co.gitt.kworks.projects.dh.web.chngeDetct;
...
public class ChangeDetectionController {
	...
	public String modifyChangeDetectionDetailsPage(@PathVariable("chngeDetctNo") Long chngeDetctNo, Model model) {
		model.addAttribute("data", changeDetectionService.selectOneChangeDetectionDetails(chngeDetctNo));
		return "/projects/dh/job/changeDetection/modifyChangeDetectionDetails";
	}
	...
	public String selectOneChangeDetectionAreaPage(@PathVariable("chngeAreaNo") Long chngeAreaNo, Model model) {
		...
		return "/projects/dh/job/changeDetection/veiwChangeDetectionArea";
	}
	...
	public String modifyChangeDetectionAreaPage(@PathVariable("chngeAreaNo") Long chngeAreaNo, Model model) {
		model.addAttribute("data", changeDetectionService.selectOneChangeDetectionArea(chngeAreaNo));
		return "/projects/dh/job/changeDetection/modifyChangeDetectionArea";
	}
	...
	public String modifyChangeDetectionArea(@PathVariable("chngeAreaNo") Long chngeAreaNo, ChgAreaDt chgAreaDt, String[] data, Model model) throws Exception, FdlException, IOException {
	...
	public String addChangeDetectionAreaPage(ChgDtlsDt chgDtlsDt, Model model) {
		return "/projects/dh/job/changeDetection/addChangeDetectionArea";
	}
	...
	public String addChangeDetectionArea(ChgAreaDt chgAreaDt, String[] data, Model model) throws Exception, FdlException, IOException {
		UserDTO userDTO = (UserDTO) EgovUserDetailsHelper.getAuthenticatedUser();
