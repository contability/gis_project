...
import kr.co.gitt.kworks.projects.sc.mappers.WttChngDtMapper;
import kr.co.gitt.kworks.projects.sc.mappers.WttConsMaMapper;
import kr.co.gitt.kworks.projects.sc.mappers.WttCostDtMapper;
import kr.co.gitt.kworks.projects.sc.mappers.WttFlawDtMapper;
import kr.co.gitt.kworks.projects.sc.mappers.WttSubcDtMapper;
...
public class WrppCntrwkRegstrServiceImpl implements WrppCntrwkRegstrService {
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.sc.service.cntrwkRegstr.CntrwkRegstrService#listWrpp(kr.co.gitt.kworks.projects.sc.model.WttConsMa)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.sc.service.cntrwkRegstr.CntrwkRegstrService#modifyWrppCntrwkRegstr(kr.co.gitt.kworks.projects.sc.model.WttConsMa)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.sc.service.cntrwkRegstr.CntrwkRegstrService#addWrppCntrwkRegstr(kr.co.gitt.kworks.projects.sc.model.WttConsMa)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.sc.service.cntrwkRegstr.CntrwkRegstrService#listWrppFlawMendngDtls(kr.co.gitt.kworks.projects.sc.model.WttFlawDt)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.sc.service.cntrwkRegstr.CntrwkRegstrService#selectOneWrppFlawMendngDtls(java.lang.Long, java.lang.Long)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.sc.service.cntrwkRegstr.CntrwkRegstrService#modifyWrppFlawMendngDtls(kr.co.gitt.kworks.projects.sc.model.WttFlawDt)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.sc.service.cntrwkRegstr.CntrwkRegstrService#addWrppFlawMendngDtls(kr.co.gitt.kworks.projects.sc.model.WttFlawDt)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.sc.service.cntrwkRegstr.CntrwkRegstrService#removeWrppFlawMendngDtls(java.lang.Long)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.sc.service.cntrwkRegstr.CntrwkRegstrService#listWrppCntrwkCtPymntDtls(kr.co.gitt.kworks.projects.sc.model.WttCostDt)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.sc.service.cntrwkRegstr.CntrwkRegstrService#selectOneWrppCntrwkCtPymntDtls(java.lang.Long, java.lang.Long)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.sc.service.cntrwkRegstr.CntrwkRegstrService#modifyWrppCntrwkCtPymntDtls(kr.co.gitt.kworks.projects.sc.model.WttCostDt)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.sc.service.cntrwkRegstr.CntrwkRegstrService#addWrppCntrwkCtPymntDtls(kr.co.gitt.kworks.projects.sc.model.WttCostDt)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.sc.service.cntrwkRegstr.CntrwkRegstrService#removeWrppCntrwkCtPymntDtls(java.lang.Long)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.sc.service.cntrwkRegstr.CntrwkRegstrService#listWrppDsgnChangeDtls(kr.co.gitt.kworks.projects.sc.model.WttChngDt)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.sc.service.cntrwkRegstr.CntrwkRegstrService#selectOneWrppDsgnChangeDtls(java.lang.Long, java.lang.Long)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.sc.service.cntrwkRegstr.CntrwkRegstrService#modifyWrppDsgnChangeDtls(kr.co.gitt.kworks.projects.sc.model.WttChngDt)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.sc.service.cntrwkRegstr.CntrwkRegstrService#addWrppDsgnChangeDtls(kr.co.gitt.kworks.projects.sc.model.WttChngDt)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.sc.service.cntrwkRegstr.CntrwkRegstrService#removeWrppDsgnChangeDtls(java.lang.Long)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.sc.service.cntrwkRegstr.CntrwkRegstrService#listWrppSubcntrDtls(kr.co.gitt.kworks.projects.sc.model.WttSubcDt)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.sc.service.cntrwkRegstr.CntrwkRegstrService#selectOneWrppSubcntrDtls(java.lang.Long, java.lang.Long)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.sc.service.cntrwkRegstr.CntrwkRegstrService#modifyWrppSubcntrDtls(kr.co.gitt.kworks.projects.sc.model.WttSubcDt)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.sc.service.cntrwkRegstr.CntrwkRegstrService#addWrppSubcntrDtls(kr.co.gitt.kworks.projects.sc.model.WttSubcDt)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.sc.service.cntrwkRegstr.CntrwkRegstrService#removeWrppSubcntrDtls(java.lang.Long)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.sc.service.cntrwkRegstr.WrppCntrwkRegstrService#addWrppCntrwkRegstrPhoto(kr.co.gitt.kworks.model.KwsImage, org.springframework.web.multipart.MultipartRequest)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.sc.service.cntrwkRegstr.WrppCntrwkRegstrService#modifyWrppCntrwkRegstrPhoto(kr.co.gitt.kworks.model.KwsImage, org.springframework.web.multipart.MultipartRequest)
	/////////////////////////////////////////////
	@Override
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.sc.service.cntrwkRegstr.WrppCntrwkRegstrService#searchSpatial(java.lang.Long)
	/////////////////////////////////////////////
	@Override
