goog.provide('kworks.interaction.DragZoomIn');
...
kworks.interaction.DragZoomIn = function(opt_options) {
...
goog.inherits(kworks.interaction.DragZoomIn, ol.interaction.DragZoom);


/**
 * @inheritDoc
 */
kworks.interaction.DragZoomIn.prototype.onBoxEnd = function() {
  var map = this.getMap();
