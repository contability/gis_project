...
<div id="div_reexmn_select" class="layerCont">
	<table id="etUV_main" class="cmmTable v2 ma_b_30" summary="재조사 테이블" style="table-layout: fixed; word-wrap: break-word;">
		<caption>재조사 테이블</caption>
		<colgroup>
			<col width="22%">
			<col width="28%">
			<col width="20%">
	...
	<table class="cmmTable v2 ma_b_30" summary="재조사 지적 정보 테이블">
		<caption>재조사 지적 정보 테이블</caption>
		<colgroup>
			<col width="30%">
			<col width="10%">
			<col width="10%">
...
<p class="btnRight v2">
	<button id="a_close_reexmn" class="button_flat_normal btn_blue">닫기</button>
</p>