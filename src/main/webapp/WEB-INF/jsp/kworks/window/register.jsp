...
<div id="div_window_register_tools">
	<a href="#" id="div_window_register_tools_prev" class="icon-back"></a>
	<a href="#" id="div_window_register_tools_next" class="icon-next"></a>
</div>