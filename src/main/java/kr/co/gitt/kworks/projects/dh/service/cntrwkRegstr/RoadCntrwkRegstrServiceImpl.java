...
import kr.co.gitt.kworks.projects.dh.mappers.RdtChngDtMapper;
import kr.co.gitt.kworks.projects.dh.mappers.RdtConsMaMapper;
import kr.co.gitt.kworks.projects.dh.mappers.RdtCostDtMapper;
import kr.co.gitt.kworks.projects.dh.mappers.RdtFlawDtMapper;
import kr.co.gitt.kworks.projects.dh.mappers.RdtSubcDtMapper;
...
public class RoadCntrwkRegstrServiceImpl implements RoadCntrwkRegstrService {
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.dh.service.cntrwkRegstr.CntrwkRegstrService#listRoad(kr.co.gitt.kworks.projects.dh.model.RdtConsMa)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.dh.service.cntrwkRegstr.CntrwkRegstrService#modifyRoadCntrwkRegstr(kr.co.gitt.kworks.projects.dh.model.RdtConsMa)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.dh.service.cntrwkRegstr.CntrwkRegstrService#addRoadCntrwkRegstr(kr.co.gitt.kworks.projects.dh.model.RdtConsMa)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.dh.service.cntrwkRegstr.CntrwkRegstrService#listRoadFlawMendngDtls(kr.co.gitt.kworks.projects.dh.model.RdtFlawDt)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.dh.service.cntrwkRegstr.CntrwkRegstrService#selectOneRoadFlawMendngDtls(java.lang.Long, java.lang.Long)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.dh.service.cntrwkRegstr.CntrwkRegstrService#modifyRoadFlawMendngDtls(kr.co.gitt.kworks.projects.dh.model.RdtFlawDt)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.dh.service.cntrwkRegstr.CntrwkRegstrService#addRoadFlawMendngDtls(kr.co.gitt.kworks.projects.dh.model.RdtFlawDt)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.dh.service.cntrwkRegstr.CntrwkRegstrService#removeRoadFlawMendngDtls(java.lang.Long)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.dh.service.cntrwkRegstr.CntrwkRegstrService#listRoadCntrwkCtPymntDtls(kr.co.gitt.kworks.projects.dh.model.RdtCostDt)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.dh.service.cntrwkRegstr.CntrwkRegstrService#selectOneRoadCntrwkCtPymntDtls(java.lang.Long, java.lang.Long)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.dh.service.cntrwkRegstr.CntrwkRegstrService#modifyRoadCntrwkCtPymntDtls(kr.co.gitt.kworks.projects.dh.model.RdtCostDt)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.dh.service.cntrwkRegstr.CntrwkRegstrService#addRoadCntrwkCtPymntDtls(kr.co.gitt.kworks.projects.dh.model.RdtCostDt)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.dh.service.cntrwkRegstr.CntrwkRegstrService#removeRoadCntrwkCtPymntDtls(java.lang.Long)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.dh.service.cntrwkRegstr.CntrwkRegstrService#listRoadDsdhChangeDtls(kr.co.gitt.kworks.projects.dh.model.RdtChngDt)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.dh.service.cntrwkRegstr.CntrwkRegstrService#selectOneRoadDsgnChangeDtls(java.lang.Long, java.lang.Long)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.dh.service.cntrwkRegstr.CntrwkRegstrService#modifyRoadDsgnChangeDtls(kr.co.gitt.kworks.projects.dh.model.RdtChngDt)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.dh.service.cntrwkRegstr.CntrwkRegstrService#addRoadDsgnChangeDtls(kr.co.gitt.kworks.projects.dh.model.RdtChngDt)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.dh.service.cntrwkRegstr.CntrwkRegstrService#removeRoadDsgnChangeDtls(java.lang.Long)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.dh.service.cntrwkRegstr.CntrwkRegstrService#listRoadSubcntrDtls(kr.co.gitt.kworks.projects.dh.model.RdtSubcDt)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.dh.service.cntrwkRegstr.CntrwkRegstrService#selectOneRoadSubcntrDtls(java.lang.Long, java.lang.Long)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.dh.service.cntrwkRegstr.CntrwkRegstrService#modifyRoadSubcntrDtls(kr.co.gitt.kworks.projects.dh.model.RdtSubcDt)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.dh.service.cntrwkRegstr.CntrwkRegstrService#addRoadSubcntrDtls(kr.co.gitt.kworks.projects.dh.model.RdtSubcDt)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.dh.service.cntrwkRegstr.CntrwkRegstrService#removeRoadSubcntrDtls(java.lang.Long)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.dh.service.cntrwkRegstr.RoadCntrwkRegstrService#addRoadCntrwkRegstrPhoto(kr.co.gitt.kworks.model.KwsImage, org.springframework.web.multipart.MultipartRequest)
	/////////////////////////////////////////////
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.dh.service.cntrwkRegstr.RoadCntrwkRegstrService#modifyRoadCntrwkRegstrPhoto(kr.co.gitt.kworks.model.KwsImage, org.springframework.web.multipart.MultipartRequest)
	/////////////////////////////////////////////
	@Override
	...
	/// @remark
	/// - 오버라이드 함수의 상세 설명
	/// @see kr.co.gitt.kworks.projects.dh.service.cntrwkRegstr.RoadCntrwkRegstrService#searchSpatial(java.lang.Long)
	/////////////////////////////////////////////
	@Override
