...
import kr.co.gitt.kworks.projects.dh.service.civilAppeal.DrngEqpCnfmPrmisnService;
...
public class DrngEqpCnfmPrmisnManageController {
	...
	public String searchDrngEqpCnfmPrmisnPage(SwtSpmtMa swtSpmtMa, Model model) {
		...
		// 하수처리구분
		kwsDomnCode.setDomnId("KWS-0955");
		...
		return "/projects/dh/job/civilAppeal/swge/searchDrngEqpCnfmPrmisn";
	}
