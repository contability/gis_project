...
mesrSgnalSttusExaminHistObj.add = {
	...
	init : function() {
		...
		$("form", that.selector).ajaxForm({
			...
			success : function(result) {
				if(result) {
					mesrSgnalSttusExaminHistObj.open(that.ftfCde, that.ftfIdn);
					that.close();
	...
	bindEvents : function() {
		...
		$("#a_save_addMesrSgnalSttusExaminHist", that.selector).on("click", function() {
			...
			that.ftfCde = $("#ftfCde").val();
			that.ftfIdn = $("#ftfIdn").val();
...
mesrSgnalSttusExaminHistObj.view = {
	...
	bindEvents : function() {
		...
		$("#a_print_viewMesrSgnalSttusExaminHist", that.selector).on("click", function() {
			var ftfCde = $("#ftfCde", that.selector).val();
			var ftfIdn = $("#ftfIdn", that.selector).val();
